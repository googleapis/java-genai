...
public class LocalTokenizerTest {
  ...
  @Mock
  private LocalTokenizerProcessor mockedProcessor;
  @Mock
  private ModelProto mockedProto;
  ...
  void constructor_unsupportedModel_throwsException() {
    ...
    try (MockedStatic<LocalTokenizerLoader> mockedLoader = Mockito.mockStatic(LocalTokenizerLoader.class)) {
      mockedLoader
      ...
      IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
          () -> new LocalTokenizer(unsupportedModel));
  ...
  void countTokens_string() throws Exception {
    ...
    CountTokensResponse response = tokenizer.countTokens(text, null);
  ...
  void countTokens_content() throws Exception {
    ...
    CountTokensResponse response = tokenizer.countTokens(content, null);
    assertEquals(2, response.totalTokens().get());
  }
  ...
  void countTokens_withConfig() throws Exception {
        ...
        .functionDeclarations(
            FunctionDeclaration.builder()
                ...
                .parameters(
                    Schema.builder()
                        .properties(
                            ImmutableMap.of("hello", Schema.builder().description("!").build()))))
        .build();
    ...
    when(mockedProcessor.encode("hello world")).thenReturn(ImmutableList.of(new Token("hello world", 3)));
    ...
    CountTokensResponse response = tokenizer.countTokens(contents, config);
  ...
  void countTokens_withFunctionCalling() throws Exception {
    ...
    CountTokensResponse response = tokenizer.countTokens(ImmutableList.of(content), null);
  ...
  void countTokens_unsupportedPart_throwsException() {
    ...
    IllegalArgumentException e = assertThrows(IllegalArgumentException.class,
        () -> tokenizer.countTokens(content, null));
  ...
  void computeTokens_string() throws Exception {
    ...
    ComputeTokensResponse response = tokenizer.computeTokens(text);
  ...
  void computeTokens_withBytePiece() throws Exception {
    ...
    assertTrue(Arrays.equals(expectedBytes, response.tokensInfo().get().get(0).tokens().get().get(0)));
  }
}
