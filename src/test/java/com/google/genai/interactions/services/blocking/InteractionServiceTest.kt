...
internal class InteractionServiceTest {
    ...
    @Test
    fun create() {
        val client = GeminiNextGenApiOkHttpClient.builder().apiKey("My API Key").build()
    ...
    fun createStreaming() {
        ...
        val interactionStreamResponse =
            interactionService.createStreaming(
                InteractionCreateParams.builder()
                    .apiVersion("api_version")
                    .body(
                        CreateModelInteractionParams.builder()
        ...
        interactionStreamResponse.use {
            interactionStreamResponse.stream().forEach { interaction -> interaction.validate() }
        }
    }
    ...
    fun getStreaming() {
        ...
        val interactionStreamResponse =
            interactionService.getStreaming(
                InteractionGetParams.builder()
                    .apiVersion("api_version")
                    .id("id")
                    .includeInput(true)
