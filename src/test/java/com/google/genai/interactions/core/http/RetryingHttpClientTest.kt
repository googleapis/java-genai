...
import com.google.genai.interactions.client.okhttp.OkHttpClient
import com.google.genai.interactions.core.RequestOptions
import com.google.genai.interactions.core.Sleeper
import com.google.genai.interactions.errors.GeminiNextGenApiRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw GeminiNextGenApiRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            GeminiNextGenApiRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
