...
internal class InteractionCreatedEventTest {

    @Test
    fun create() {
        val interactionCreatedEvent =
        ...
        assertThat(interactionCreatedEvent.interaction())
            .isEqualTo(
                Interaction.builder()
        ...
        assertThat(interactionCreatedEvent.eventId()).contains("event_id")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInteractionCreatedEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(interactionCreatedEvent),
                jacksonTypeRef<InteractionCreatedEvent>(),
            )

        assertThat(roundtrippedInteractionCreatedEvent).isEqualTo(interactionCreatedEvent)
    }
}
