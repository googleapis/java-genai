...
public class LocalTokenizerProcessorTest {
    ...
    void setUp() {
        ...
        ModelProto testProto = ModelProto.newBuilder()
                .setTrainerSpec(TrainerSpec.newBuilder().setModelType(TrainerSpec.ModelType.BPE).setVocabSize(0)
                        .setUnkId(0).build())
                .setNormalizerSpec(
                        NormalizerSpec.newBuilder().setAddDummyPrefix(false).setRemoveExtraWhitespaces(false).build())
                // 0: <unk>
                .addPieces(
    ...
    void encode_simpleString_returnsCorrectTokens() throws Exception {
        ...
        List<Token> expectedTokens = ImmutableList.of(new Token("hello", 15),
                new Token("▁world", 14));
    ...
    void encode_stringWithSubwords_returnsCorrectTokens() throws Exception {
        ...
        ModelProto subwordProto = ModelProto.newBuilder()
