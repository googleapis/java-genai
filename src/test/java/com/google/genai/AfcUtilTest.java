...
import com.google.genai.types.ToolComputerUse;
  ...
  public void findAfcIncompatibleToolIndexes_withOnlyCompatibleTools_returnsEmptyList()
    ...
    GenerateContentConfig config =
        GenerateContentConfig.builder()
            ...
            .tools(Tool.builder().computerUse(ToolComputerUse.builder()))
    ...
    GenerateContentConfig config =
        GenerateContentConfig.builder()
            .tools(
                ...
                Tool.builder().computerUse(ToolComputerUse.builder()).build(),
