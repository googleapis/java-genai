...
public class AsyncCachesTest {
  ...
  public void testAsyncDeleteCachedContent(boolean vertexAI)
    ...
    DeleteCachedContentResponse response =
        client.async.caches.delete(cacheName, DeleteCachedContentConfig.builder().build()).get();
  ...
  public void testAsyncGetCachedContent(boolean vertexAI)
    ...
    CachedContent response =
        client.async.caches.get(cacheName, GetCachedContentConfig.builder().build()).get();
