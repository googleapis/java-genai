...
private constructor(
    ...
    ) : this(type, documentUri, endIndex, fileName, source, startIndex, mutableMapOf())
    ...
    override fun toString() =
        "FileCitation{type=$type, documentUri=$documentUri, endIndex=$endIndex, fileName=$fileName, source=$source, startIndex=$startIndex, additionalProperties=$additionalProperties}"
}
