...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CodeExecutionResultContent].
         *
    ...
    /** A builder for [CodeExecutionResultContent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(codeExecutionResultContent: CodeExecutionResultContent) = apply {
            callId = codeExecutionResultContent.callId
            result = codeExecutionResultContent.result
            type = codeExecutionResultContent.type
            isError = codeExecutionResultContent.isError
            signature = codeExecutionResultContent.signature
            additionalProperties = codeExecutionResultContent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CodeExecutionResultContent].
         *
         ...
         */
        fun build(): CodeExecutionResultContent =
    ...
    fun validate(): CodeExecutionResultContent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CodeExecutionResultContent &&
            callId == other.callId &&
            result == other.result &&
            type == other.type &&
    ...
    override fun toString() =
        "CodeExecutionResultContent{callId=$callId, result=$result, type=$type, isError=$isError, signature=$signature, additionalProperties=$additionalProperties}"
}
