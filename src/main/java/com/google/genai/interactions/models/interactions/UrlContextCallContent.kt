...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UrlContextCallContent].
         *
    ...
    /** A builder for [UrlContextCallContent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(urlContextCallContent: UrlContextCallContent) = apply {
            id = urlContextCallContent.id
            arguments = urlContextCallContent.arguments
            type = urlContextCallContent.type
            signature = urlContextCallContent.signature
            additionalProperties = urlContextCallContent.additionalProperties.toMutableMap()
        }
        ...
        /** Required. The arguments to pass to the URL context. */
        fun arguments(arguments: UrlContextCallArguments) = arguments(JsonField.of(arguments))

        /**
         * Sets [Builder.arguments] to an arbitrary JSON value.
         *
         * You should usually call [Builder.arguments] with a well-typed [UrlContextCallArguments]
        ...
        /**
         * Returns an immutable instance of [UrlContextCallContent].
         *
         ...
         */
        fun build(): UrlContextCallContent =
    ...
    fun validate(): UrlContextCallContent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UrlContextCallContent &&
            id == other.id &&
    ...
    override fun toString() =
        "UrlContextCallContent{id=$id, arguments=$arguments, type=$type, signature=$signature, additionalProperties=$additionalProperties}"
}
