...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CodeExecutionCallArguments].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CodeExecutionCallArguments]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(codeExecutionCallArguments: CodeExecutionCallArguments) = apply {
            code = codeExecutionCallArguments.code
            language = codeExecutionCallArguments.language
            additionalProperties = codeExecutionCallArguments.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CodeExecutionCallArguments].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CodeExecutionCallArguments =
            CodeExecutionCallArguments(code, language, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CodeExecutionCallArguments = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CodeExecutionCallArguments &&
            code == other.code &&
    ...
    override fun toString() =
        "CodeExecutionCallArguments{code=$code, language=$language, additionalProperties=$additionalProperties}"
}
