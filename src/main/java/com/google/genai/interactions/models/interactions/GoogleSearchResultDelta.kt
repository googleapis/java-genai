...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GoogleSearchResultDelta].
         *
    ...
    /** A builder for [GoogleSearchResultDelta]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(googleSearchResultDelta: GoogleSearchResultDelta) = apply {
            result = googleSearchResultDelta.result.map { it.toMutableList() }
            type = googleSearchResultDelta.type
            isError = googleSearchResultDelta.isError
            signature = googleSearchResultDelta.signature
            additionalProperties = googleSearchResultDelta.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GoogleSearchResultDelta].
         *
         ...
         */
        fun build(): GoogleSearchResultDelta =
    ...
    fun validate(): GoogleSearchResultDelta = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GoogleSearchResultDelta &&
            result == other.result &&
            type == other.type &&
    ...
    override fun toString() =
        "GoogleSearchResultDelta{result=$result, type=$type, isError=$isError, signature=$signature, additionalProperties=$additionalProperties}"
}
