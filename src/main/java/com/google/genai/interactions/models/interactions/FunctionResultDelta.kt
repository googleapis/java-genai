...
private constructor(
    ...
    ) : this(callId, result, type, isError, name, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FunctionResultDelta].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(functionResultDelta: FunctionResultDelta) = apply {
            callId = functionResultDelta.callId
            result = functionResultDelta.result
            type = functionResultDelta.type
            isError = functionResultDelta.isError
            name = functionResultDelta.name
            additionalProperties = functionResultDelta.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): FunctionResultDelta = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        override fun hashCode(): Int = Objects.hash(jsonValue, functionResultSubcontentList, string)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FunctionResultDelta &&
            callId == other.callId &&
            result == other.result &&
            type == other.type &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(callId, result, type, isError, name, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "FunctionResultDelta{callId=$callId, result=$result, type=$type, isError=$isError, name=$name, additionalProperties=$additionalProperties}"
}
