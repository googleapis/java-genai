...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [DocumentContent]. */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(documentContent: DocumentContent) = apply {
            type = documentContent.type
            data = documentContent.data
            mimeType = documentContent.mimeType
            uri = documentContent.uri
            additionalProperties = documentContent.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): DocumentContent =
            DocumentContent(type, data, mimeType, uri, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): DocumentContent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "DocumentContent{type=$type, data=$data, mimeType=$mimeType, uri=$uri, additionalProperties=$additionalProperties}"
}
