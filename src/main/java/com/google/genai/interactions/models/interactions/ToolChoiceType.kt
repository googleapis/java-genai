...
class ToolChoiceType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        @JvmStatic fun of(value: String) = ToolChoiceType(JsonField.of(value))
    }
     ...
     *
     * An instance of [ToolChoiceType] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        VALIDATED,
        /**
         * An enum member indicating that [ToolChoiceType] was instantiated with an unknown value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            else -> throw GeminiNextGenApiInvalidDataException("Unknown ToolChoiceType: $value")
        }
    ...
    fun validate(): ToolChoiceType = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ToolChoiceType && value == other.value
    }
