...
private constructor(
    ...
    ) : this(eventType, error, eventId, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        private var eventType: JsonValue = JsonValue.from("error")
        ...
        fun build(): ErrorEvent =
            ErrorEvent(eventType, error, eventId, additionalProperties.toMutableMap())
    }
    ...
    internal fun validity(): Int =
        eventType.let { if (it == JsonValue.from("error")) 1 else 0 } +
    ...
    private val hashCode: Int by lazy {
        Objects.hash(eventType, error, eventId, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ErrorEvent{eventType=$eventType, error=$error, eventId=$eventId, additionalProperties=$additionalProperties}"
}
