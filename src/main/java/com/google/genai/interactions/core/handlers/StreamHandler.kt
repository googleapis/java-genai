...
import com.google.genai.interactions.core.http.PhantomReachableClosingStreamResponse
...
/** A sequence that catches, wraps, and rethrows [IOException] as [GeminiNextGenApiIoException]. */
        ...
        return object : Iterator<T> {
            ...
            override fun next(): T =
                try {
                    ...
                    throw GeminiNextGenApiIoException("Stream failed", e)
                }
