...
public final class Batches {
  ...
  ObjectNode urlContextMetadataToMldev(JsonNode fromObject, ObjectNode parentObject) {
    ...
    if (Common.getValueByPath(fromObject, new String[] {"urlMetadata"}) != null) {
      ...
      for (JsonNode item : keyArray) {
        result.add(urlMetadataToMldev(JsonSerializable.toJsonNode(item), toObject));
      }
  ...
  ObjectNode generateContentResponseToMldev(JsonNode fromObject, ObjectNode parentObject) {
    ...
    if (Common.getValueByPath(fromObject, new String[] {"candidates"}) != null) {
      ...
      for (JsonNode item : keyArray) {
        result.add(candidateToMldev(JsonSerializable.toJsonNode(item), toObject));
      }
  ...
  ObjectNode batchJobDestinationToMldev(JsonNode fromObject, ObjectNode parentObject) {
    ...
    if (Common.getValueByPath(fromObject, new String[] {"fileName"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"responsesFile"},
          Common.getValueByPath(fromObject, new String[] {"fileName"}));
    }

    if (Common.getValueByPath(fromObject, new String[] {"inlinedResponses"}) != null) {
      ArrayNode keyArray =
          (ArrayNode) Common.getValueByPath(fromObject, new String[] {"inlinedResponses"});
      ObjectMapper objectMapper = new ObjectMapper();
      ArrayNode result = objectMapper.createArrayNode();

      for (JsonNode item : keyArray) {
        result.add(inlinedResponseToMldev(JsonSerializable.toJsonNode(item), toObject));
      }
      Common.setValueByPath(
          toObject, new String[] {"inlinedResponses", "inlinedResponses"}, result);
    }
  ...
  ObjectNode urlContextMetadataToVertex(JsonNode fromObject, ObjectNode parentObject) {
    ...
    if (Common.getValueByPath(fromObject, new String[] {"urlMetadata"}) != null) {
      ...
      for (JsonNode item : keyArray) {
        result.add(urlMetadataToVertex(JsonSerializable.toJsonNode(item), toObject));
      }
      Common.setValueByPath(toObject, new String[] {"urlMetadata"}, result);
    }
  ...
  ObjectNode generateContentResponseToVertex(JsonNode fromObject, ObjectNode parentObject) {
    ...
    if (Common.getValueByPath(fromObject, new String[] {"candidates"}) != null) {
      ...
      for (JsonNode item : keyArray) {
        result.add(candidateToVertex(JsonSerializable.toJsonNode(item), toObject));
      }
      Common.setValueByPath(toObject, new String[] {"candidates"}, result);
    }
  ...
  ObjectNode googleSearchRetrievalFromMldev(JsonNode fromObject, ObjectNode parentObject) {
    ...
    if (Common.getValueByPath(fromObject, new String[] {"dynamicRetrievalConfig"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"dynamicRetrievalConfig"},
          dynamicRetrievalConfigFromMldev(
              JsonSerializable.toJsonNode(
                  Common.getValueByPath(fromObject, new String[] {"dynamicRetrievalConfig"})),
              toObject));
    }
  ...
  ObjectNode toolFromMldev(JsonNode fromObject, ObjectNode parentObject) {
    ...
    if (Common.getValueByPath(fromObject, new String[] {"functionDeclarations"}) != null) {
      ...
      for (JsonNode item : keyArray) {
        result.add(functionDeclarationFromMldev(JsonSerializable.toJsonNode(item), toObject));
      }
      Common.setValueByPath(toObject, new String[] {"functionDeclarations"}, result);
    }
    ...
    if (Common.getValueByPath(fromObject, new String[] {"googleSearchRetrieval"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"googleSearchRetrieval"},
          googleSearchRetrievalFromMldev(
              JsonSerializable.toJsonNode(
                  Common.getValueByPath(fromObject, new String[] {"googleSearchRetrieval"})),
              toObject));
    }
  ...
  ObjectNode multiSpeakerVoiceConfigFromMldev(JsonNode fromObject, ObjectNode parentObject) {
    ...
    if (Common.getValueByPath(fromObject, new String[] {"speakerVoiceConfigs"}) != null) {
      ...
      for (JsonNode item : keyArray) {
        result.add(speakerVoiceConfigFromMldev(JsonSerializable.toJsonNode(item), toObject));
      }
      Common.setValueByPath(toObject, new String[] {"speakerVoiceConfigs"}, result);
    }
  ...
  ObjectNode speechConfigFromMldev(JsonNode fromObject, ObjectNode parentObject) {
    ...
    if (Common.getValueByPath(fromObject, new String[] {"multiSpeakerVoiceConfig"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"multiSpeakerVoiceConfig"},
          multiSpeakerVoiceConfigFromMldev(
              JsonSerializable.toJsonNode(
                  Common.getValueByPath(fromObject, new String[] {"multiSpeakerVoiceConfig"})),
              toObject));
    }
  ...
  ObjectNode generateContentConfigFromMldev(
    ...
    if (Common.getValueByPath(parentObject, new String[] {"systemInstruction"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"systemInstruction"},
          contentFromMldev(
              JsonSerializable.toJsonNode(
                  Transformers.tContent(
                      Common.getValueByPath(parentObject, new String[] {"systemInstruction"}))),
              toObject));
    }
    ...
    if (Common.getValueByPath(parentObject, new String[] {"safetySettings"}) != null) {
      ArrayNode keyArray =
          (ArrayNode) Common.getValueByPath(parentObject, new String[] {"safetySettings"});
      ObjectMapper objectMapper = new ObjectMapper();
      ArrayNode result = objectMapper.createArrayNode();

      for (JsonNode item : keyArray) {
        result.add(safetySettingFromMldev(JsonSerializable.toJsonNode(item), toObject));
      }
      Common.setValueByPath(toObject, new String[] {"safetySettings"}, result);
    }

    if (Common.getValueByPath(parentObject, new String[] {"tools"}) != null) {
      ArrayNode keyArray =
          (ArrayNode)
              Transformers.tTools(Common.getValueByPath(parentObject, new String[] {"tools"}));
      ObjectMapper objectMapper = new ObjectMapper();
      ArrayNode result = objectMapper.createArrayNode();

      for (JsonNode item : keyArray) {
        result.add(toolFromMldev(JsonSerializable.toJsonNode(Transformers.tTool(item)), toObject));
      }
      Common.setValueByPath(toObject, new String[] {"tools"}, result);
    }

    if (Common.getValueByPath(parentObject, new String[] {"toolConfig"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"toolConfig"},
          toolConfigFromMldev(
              JsonSerializable.toJsonNode(
                  Common.getValueByPath(parentObject, new String[] {"toolConfig"})),
              toObject));
    }

    if (Common.getValueByPath(parentObject, new String[] {"cachedContent"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"cachedContent"},
          Transformers.tCachedContentName(
              this.apiClient, Common.getValueByPath(parentObject, new String[] {"cachedContent"})));
    }
  ...
  ObjectNode inlinedRequestFromMldev(
    ...
    if (Common.getValueByPath(fromObject, new String[] {"request", "model"}) != null) {
      Common.setValueByPath(
          ...
          Transformers.tModel(
              this.apiClient,
              Common.getValueByPath(fromObject, new String[] {"request", "model"})));
    }
      ...
      ArrayNode keyArray =
          (ArrayNode)
              Transformers.tContents(
                  Common.getValueByPath(fromObject, new String[] {"request", "contents"}));
      ObjectMapper objectMapper = new ObjectMapper();
      ArrayNode result = objectMapper.createArrayNode();

      for (JsonNode item : keyArray) {
        result.add(contentFromMldev(JsonSerializable.toJsonNode(item), toObject));
      }
    ...
    if (Common.getValueByPath(fromObject, new String[] {"request", "generationConfig"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"config"},
          generateContentConfigFromMldev(
              apiClient,
              JsonSerializable.toJsonNode(
                  Common.getValueByPath(fromObject, new String[] {"request", "generationConfig"})),
              toObject));
    }
  ...
  @ExcludeFromGeneratedCoverageReport
  ObjectNode batchJobSourceFromMldev(
      ApiClient apiClient, JsonNode fromObject, ObjectNode parentObject) {
    ObjectNode toObject = JsonSerializable.objectMapper.createObjectNode();
    ...
    if (Common.getValueByPath(fromObject, new String[] {"requests", "requests"}) != null) {
      ArrayNode keyArray =
          (ArrayNode) Common.getValueByPath(fromObject, new String[] {"requests", "requests"});
      ObjectMapper objectMapper = new ObjectMapper();
      ArrayNode result = objectMapper.createArrayNode();

      for (JsonNode item : keyArray) {
        result.add(inlinedRequestFromMldev(apiClient, JsonSerializable.toJsonNode(item), toObject));
      }
  ...
  ObjectNode googleSearchRetrievalFromVertex(JsonNode fromObject, ObjectNode parentObject) {
    ...
    if (Common.getValueByPath(fromObject, new String[] {"dynamicRetrievalConfig"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"dynamicRetrievalConfig"},
          dynamicRetrievalConfigFromVertex(
              JsonSerializable.toJsonNode(
                  Common.getValueByPath(fromObject, new String[] {"dynamicRetrievalConfig"})),
              toObject));
    }
  ...
  ObjectNode toolFromVertex(JsonNode fromObject, ObjectNode parentObject) {
    ...
    if (Common.getValueByPath(fromObject, new String[] {"functionDeclarations"}) != null) {
      ...
      for (JsonNode item : keyArray) {
        result.add(functionDeclarationFromVertex(JsonSerializable.toJsonNode(item), toObject));
      }
      Common.setValueByPath(toObject, new String[] {"functionDeclarations"}, result);
    }
    ...
    if (Common.getValueByPath(fromObject, new String[] {"googleSearchRetrieval"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"googleSearchRetrieval"},
          googleSearchRetrievalFromVertex(
              JsonSerializable.toJsonNode(
                  Common.getValueByPath(fromObject, new String[] {"googleSearchRetrieval"})),
              toObject));
    }
  ...
  ObjectNode toolConfigFromVertex(JsonNode fromObject, ObjectNode parentObject) {
    ...
    if (Common.getValueByPath(fromObject, new String[] {"functionCallingConfig"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"functionCallingConfig"},
          functionCallingConfigFromVertex(
              JsonSerializable.toJsonNode(
                  Common.getValueByPath(fromObject, new String[] {"functionCallingConfig"})),
              toObject));
    }
  ...
  @ExcludeFromGeneratedCoverageReport
  ObjectNode generateContentConfigFromVertex(
      ApiClient apiClient, JsonNode fromObject, ObjectNode parentObject) {
    ObjectNode toObject = JsonSerializable.objectMapper.createObjectNode();
    ...
    if (Common.getValueByPath(parentObject, new String[] {"safetySettings"}) != null) {
      ...
      for (JsonNode item : keyArray) {
        result.add(safetySettingFromVertex(JsonSerializable.toJsonNode(item), toObject));
      }
      Common.setValueByPath(toObject, new String[] {"safetySettings"}, result);
    }
    ...
    if (Common.getValueByPath(parentObject, new String[] {"tools"}) != null) {
      ...
      for (JsonNode item : keyArray) {
        result.add(toolFromVertex(JsonSerializable.toJsonNode(Transformers.tTool(item)), toObject));
      }
      Common.setValueByPath(toObject, new String[] {"tools"}, result);
    }
    ...
    if (Common.getValueByPath(parentObject, new String[] {"toolConfig"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"toolConfig"},
          toolConfigFromVertex(
              JsonSerializable.toJsonNode(
                  Common.getValueByPath(parentObject, new String[] {"toolConfig"})),
              toObject));
    }

    if (Common.getValueByPath(parentObject, new String[] {"labels"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"labels"},
          Common.getValueByPath(parentObject, new String[] {"labels"}));
    }
