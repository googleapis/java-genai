...
public final class Tunings {
  ...
  @ExcludeFromGeneratedCoverageReport
  ObjectNode tuningValidationDatasetToMldev(JsonNode fromObject, ObjectNode parentObject) {
    ObjectNode toObject = JsonSerializable.objectMapper.createObjectNode();
    if (!Common.isZero(Common.getValueByPath(fromObject, new String[] {"gcsUri"}))) {
      throw new IllegalArgumentException("gcsUri parameter is not supported in Gemini API.");
    }
  ...
  @ExcludeFromGeneratedCoverageReport
  ObjectNode tuningExampleToVertex(JsonNode fromObject, ObjectNode parentObject) {
    ObjectNode toObject = JsonSerializable.objectMapper.createObjectNode();
    if (!Common.isZero(Common.getValueByPath(fromObject, new String[] {"textInput"}))) {
      throw new IllegalArgumentException("textInput parameter is not supported in Vertex AI.");
    }

    if (!Common.isZero(Common.getValueByPath(fromObject, new String[] {"output"}))) {
      throw new IllegalArgumentException("output parameter is not supported in Vertex AI.");
    }
  ...
  @ExcludeFromGeneratedCoverageReport
  ObjectNode tunedModelCheckpointFromMldev(JsonNode fromObject, ObjectNode parentObject) {
    ObjectNode toObject = JsonSerializable.objectMapper.createObjectNode();
  ...
  @ExcludeFromGeneratedCoverageReport
  ObjectNode operationFromMldev(JsonNode fromObject, ObjectNode parentObject) {
    ObjectNode toObject = JsonSerializable.objectMapper.createObjectNode();
    if (Common.getValueByPath(fromObject, new String[] {"name"}) != null) {
      Common.setValueByPath(
          toObject,
  ...
  TuningJob privateGet(String name, GetTuningJobConfig config) {
    ...
    try (ApiResponse response =
      ...
      return JsonSerializable.fromJsonNode(responseNode, TuningJob.class);
    }
  }
  ...
  ListTuningJobsResponse privateList(ListTuningJobsConfig config) {
    ...
    try (ApiResponse response =
      ...
      return JsonSerializable.fromJsonNode(responseNode, ListTuningJobsResponse.class);
    }
  }
  ...
  Operation privateTuneMldev(
    ...
    try (ApiResponse response =
      ...
      if (this.apiClient.vertexAI()) {
        ...
        responseNode = operationFromMldev(responseNode, null);
      }
      return JsonSerializable.fromJsonNode(responseNode, Operation.class);
    }
  }
  ...
  public TuningJob tune(
    ...
    if (this.apiClient.vertexAI()) {
      ...
      Operation operation = this.privateTuneMldev(baseModel, trainingDataset, config);
