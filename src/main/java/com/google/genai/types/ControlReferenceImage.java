...
public abstract class ControlReferenceImage extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("config")
    public abstract Builder config(Optional<ControlReferenceConfig> config);

    public abstract ControlReferenceImage build();
  }

  /** Returns a TypeAdapter for ControlReferenceImage. */
  public static TypeAdapter<ControlReferenceImage> typeAdapter(Gson gson) {
    return new AutoValue_ControlReferenceImage.GsonTypeAdapter(gson);
  }
