...
public abstract class LogprobsResult extends JsonSerializable {
  ...
  public abstract static class Builder {
     ...
     *
     * <p>chosenCandidates: A list of the chosen candidate tokens at each decoding step. The length
     * of this list is equal to the total number of decoding steps. Note that the chosen candidate
     * might not be in `top_candidates`.
     */
    @JsonProperty("chosenCandidates")
     ...
     *
     * <p>topCandidates: A list of the top candidate tokens at each decoding step. The length of
