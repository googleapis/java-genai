...
public abstract class StyleReferenceConfig extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("styleDescription")
    public abstract Builder styleDescription(Optional<String> styleDescription);

    public abstract StyleReferenceConfig build();
  }

  /** Returns a TypeAdapter for StyleReferenceConfig. */
  public static TypeAdapter<StyleReferenceConfig> typeAdapter(Gson gson) {
    return new AutoValue_StyleReferenceConfig.GsonTypeAdapter(gson);
  }
