...
public abstract class GoogleSearchRetrieval extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("dynamicRetrievalConfig")
    public abstract Builder dynamicRetrievalConfig(
        Optional<DynamicRetrievalConfig> dynamicRetrievalConfig);

    public abstract GoogleSearchRetrieval build();
  }

  /** Returns a TypeAdapter for GoogleSearchRetrieval. */
  public static TypeAdapter<GoogleSearchRetrieval> typeAdapter(Gson gson) {
    return new AutoValue_GoogleSearchRetrieval.GsonTypeAdapter(gson);
  }
