 ...
 *
 * <p>Only generated when using the `CodeExecution` tool, in which the code will be automatically
...
public abstract class ExecutableCode extends JsonSerializable {
  ...
  public abstract static class Builder {
     ...
     * Setter for id.
     *
     * <p>id: Unique identifier of the `ExecutableCode` part. The server returns the
