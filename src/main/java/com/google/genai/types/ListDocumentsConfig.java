...
@AutoValue
@JsonDeserialize(builder = ListDocumentsConfig.Builder.class)
public abstract class ListDocumentsConfig extends JsonSerializable {
  ...
  public static Builder builder() {
    return new AutoValue_ListDocumentsConfig.Builder();
  }
  ...
  public abstract static class Builder {
    /** For internal usage. Please use `ListDocumentsConfig.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract ListDocumentsConfig build();
  }

  /** Deserializes a JSON string to a ListDocumentsConfig object. */
  @ExcludeFromGeneratedCoverageReport
  public static ListDocumentsConfig fromJson(String jsonString) {
    return Common.fromJsonString(jsonString, ListDocumentsConfig.class);
  }
}
