...
public abstract class VertexRagStore extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("ragCorpora")
    public abstract Builder ragCorpora(Optional<List<String>> ragCorpora);

    @SerializedName("ragResources")
    public abstract Builder ragResources(List<VertexRagStoreRagResource> ragResources);

    @SerializedName("ragResources")
    public abstract Builder ragResources(Optional<List<VertexRagStoreRagResource>> ragResources);

    @SerializedName("similarityTopK")
    public abstract Builder similarityTopK(Integer similarityTopK);

    @SerializedName("similarityTopK")
    public abstract Builder similarityTopK(Optional<Integer> similarityTopK);

    @SerializedName("vectorDistanceThreshold")
    public abstract Builder vectorDistanceThreshold(Double vectorDistanceThreshold);

    @SerializedName("vectorDistanceThreshold")
    public abstract Builder vectorDistanceThreshold(Optional<Double> vectorDistanceThreshold);

    public abstract VertexRagStore build();
  }

  /** Returns a TypeAdapter for VertexRagStore. */
  public static TypeAdapter<VertexRagStore> typeAdapter(Gson gson) {
    return new AutoValue_VertexRagStore.GsonTypeAdapter(gson);
  }
