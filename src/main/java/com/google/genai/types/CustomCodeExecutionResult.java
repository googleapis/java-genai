...
@AutoValue
@JsonDeserialize(builder = CustomCodeExecutionResult.Builder.class)
public abstract class CustomCodeExecutionResult extends JsonSerializable {
  ...
  public static Builder builder() {
    return new AutoValue_CustomCodeExecutionResult.Builder();
  }
  ...
  public abstract static class Builder {
    /** For internal usage. Please use `CustomCodeExecutionResult.builder()` for instantiation. */
    @JsonCreator
     ...
     * Setter for score.
     *
     * <p>score: Output only. Custom code execution score.
     */
    @JsonProperty("score")
    ...
    public abstract CustomCodeExecutionResult build();
  }

  /** Deserializes a JSON string to a CustomCodeExecutionResult object. */
  @ExcludeFromGeneratedCoverageReport
  public static CustomCodeExecutionResult fromJson(String jsonString) {
    return Common.fromJsonString(jsonString, CustomCodeExecutionResult.class);
  }
}
