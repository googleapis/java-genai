...
@AutoValue
@JsonDeserialize(builder = RecontextImageResponse.Builder.class)
public abstract class RecontextImageResponse extends JsonSerializable {
  ...
  public static Builder builder() {
    return new AutoValue_RecontextImageResponse.Builder();
  }
  ...
  public abstract static class Builder {
    /** For internal usage. Please use `RecontextImageResponse.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract RecontextImageResponse build();
  }

  /** Deserializes a JSON string to a RecontextImageResponse object. */
  @ExcludeFromGeneratedCoverageReport
  public static RecontextImageResponse fromJson(String jsonString) {
    return Common.fromJsonString(jsonString, RecontextImageResponse.class);
  }
}
