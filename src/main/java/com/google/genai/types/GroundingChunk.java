...
public abstract class GroundingChunk extends JsonSerializable {
  ...
  public abstract static class Builder {
     ...
     * Setter for maps.
     *
     * <p>maps: A `Maps` chunk is a piece of evidence that comes from Google Maps. It contains
     * information about a place, such as its name, address, and reviews. This is used to provide
