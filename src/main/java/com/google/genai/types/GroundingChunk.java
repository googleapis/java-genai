...
public abstract class GroundingChunk extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("retrievedContext")
    public abstract Builder retrievedContext(
    ...
    @SerializedName("web")
    public abstract Builder web(Optional<GroundingChunkWeb> web);

    public abstract GroundingChunk build();
  }

  /** Returns a TypeAdapter for GroundingChunk. */
  public static TypeAdapter<GroundingChunk> typeAdapter(Gson gson) {
    return new AutoValue_GroundingChunk.GsonTypeAdapter(gson);
  }
