...
public abstract class LLMBasedMetricSpec extends JsonSerializable {
  ...
  public abstract static class Builder {
     ...
     */
    @CanIgnoreReturnValue
    public Builder judgeAutoraterConfig(AutoraterConfig.Builder judgeAutoraterConfigBuilder) {
      return judgeAutoraterConfig(judgeAutoraterConfigBuilder.build());
    }
     ...
     *
     * <p>additionalConfig: Optional. Optional additional configuration for the metric.
     */
    @JsonProperty("additionalConfig")
    public abstract Builder additionalConfig(Map<String, Object> additionalConfig);

    @ExcludeFromGeneratedCoverageReport
    abstract Builder additionalConfig(Optional<Map<String, Object>> additionalConfig);
  ...
  public static LLMBasedMetricSpec fromJson(String jsonString) {
    return Common.fromJsonString(jsonString, LLMBasedMetricSpec.class);
  }
}
