...
public abstract class FunctionResponse extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("response")
    public abstract Builder response(Optional<Map<String, Object>> response);

    public abstract FunctionResponse build();
  }

  /** Returns a TypeAdapter for FunctionResponse. */
  public static TypeAdapter<FunctionResponse> typeAdapter(Gson gson) {
    return new AutoValue_FunctionResponse.GsonTypeAdapter(gson);
  }
