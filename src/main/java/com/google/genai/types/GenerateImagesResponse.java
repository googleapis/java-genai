...
public abstract class GenerateImagesResponse extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("generatedImages")
    public abstract Builder generatedImages(Optional<List<GeneratedImage>> generatedImages);

    public abstract GenerateImagesResponse build();
  }

  /** Returns a TypeAdapter for GenerateImagesResponse. */
  public static TypeAdapter<GenerateImagesResponse> typeAdapter(Gson gson) {
    return new AutoValue_GenerateImagesResponse.GsonTypeAdapter(gson);
  }
