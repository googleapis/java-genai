...
public abstract class GroundingSupport extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("confidenceScores")
    public abstract Builder confidenceScores(Optional<List<Float>> confidenceScores);

    @SerializedName("groundingChunkIndices")
    public abstract Builder groundingChunkIndices(List<Integer> groundingChunkIndices);

    @SerializedName("groundingChunkIndices")
    public abstract Builder groundingChunkIndices(Optional<List<Integer>> groundingChunkIndices);

    @SerializedName("segment")
    public abstract Builder segment(Segment segment);

    @SerializedName("segment")
    public abstract Builder segment(Optional<Segment> segment);

    public abstract GroundingSupport build();
  }

  /** Returns a TypeAdapter for GroundingSupport. */
  public static TypeAdapter<GroundingSupport> typeAdapter(Gson gson) {
    return new AutoValue_GroundingSupport.GsonTypeAdapter(gson);
  }
