...
public abstract class GoogleTypeDate extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("day")
    public abstract Builder day(Optional<Integer> day);

    @SerializedName("month")
    public abstract Builder month(Integer month);

    @SerializedName("month")
    public abstract Builder month(Optional<Integer> month);

    @SerializedName("year")
    public abstract Builder year(Integer year);

    @SerializedName("year")
    public abstract Builder year(Optional<Integer> year);

    public abstract GoogleTypeDate build();
  }

  /** Returns a TypeAdapter for GoogleTypeDate. */
  public static TypeAdapter<GoogleTypeDate> typeAdapter(Gson gson) {
    return new AutoValue_GoogleTypeDate.GsonTypeAdapter(gson);
  }
