...
public abstract class AuthToken extends JsonSerializable {
  ...
  /**
   * Optional. Input only. Immutable. The interaction ID that this token is scoped to. Specific to
   * the Live Interactions API.
   */
  ...
  public abstract static class Builder {
    ...
    /**
     * Setter for interactionId.
     *
     * <p>interactionId: Optional. Input only. Immutable. The interaction ID that this token is
     * scoped to. Specific to the Live Interactions API.
     */
    @JsonProperty("interactionId")
    ...
    /** Clears the value of interactionId field. */
    @ExcludeFromGeneratedCoverageReport
    @CanIgnoreReturnValue
