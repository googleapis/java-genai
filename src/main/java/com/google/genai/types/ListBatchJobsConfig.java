...
@AutoValue
@JsonDeserialize(builder = ListBatchJobsConfig.Builder.class)
public abstract class ListBatchJobsConfig extends JsonSerializable {
  ...
  public abstract static class Builder {
    /** For internal usage. Please use `ListBatchJobsConfig.builder()` for instantiation. */
    @JsonCreator
