...
@AutoValue
@JsonDeserialize(builder = BleuMetricValue.Builder.class)
public abstract class BleuMetricValue extends JsonSerializable {
  ...
  public static Builder builder() {
    return new AutoValue_BleuMetricValue.Builder();
  }
  ...
  public abstract static class Builder {
    /** For internal usage. Please use `BleuMetricValue.builder()` for instantiation. */
    @JsonCreator
     ...
     * Setter for score.
     *
     * <p>score: Output only. Bleu score.
     */
    @JsonProperty("score")
