...
@AutoValue
@InternalApi
@JsonDeserialize(builder = GetBatchJobParameters.Builder.class)
public abstract class GetBatchJobParameters extends JsonSerializable {
  ...
  public static Builder builder() {
    return new AutoValue_GetBatchJobParameters.Builder();
  }
  ...
  public abstract static class Builder {
    /** For internal usage. Please use `GetBatchJobParameters.builder()` for instantiation. */
    @JsonCreator
     ...
     */
    @JsonProperty("config")
    public abstract Builder config(GetBatchJobConfig config);
     ...
     */
    @CanIgnoreReturnValue
    public Builder config(GetBatchJobConfig.Builder configBuilder) {
      return config(configBuilder.build());
    }

    @ExcludeFromGeneratedCoverageReport
    abstract Builder config(Optional<GetBatchJobConfig> config);
    ...
    public abstract GetBatchJobParameters build();
  }
