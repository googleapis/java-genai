...
public abstract class ContentEmbeddingStatistics extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @ExcludeFromGeneratedCoverageReport
    abstract Builder truncated(Optional<Boolean> truncated);

    /** Clears the value of truncated field. */
    @ExcludeFromGeneratedCoverageReport
    @CanIgnoreReturnValue
    public Builder clearTruncated() {
      return truncated(Optional.empty());
    }
    ...
    @ExcludeFromGeneratedCoverageReport
    abstract Builder tokenCount(Optional<Float> tokenCount);
  ...
  public static ContentEmbeddingStatistics fromJson(String jsonString) {
    return Common.fromJsonString(jsonString, ContentEmbeddingStatistics.class);
  }
}
