...
public abstract class UpscaleImageAPIConfig extends JsonSerializable {
  ...
  /** Returns a TypeAdapter for UpscaleImageAPIConfig. */
  public static TypeAdapter<UpscaleImageAPIConfig> typeAdapter(Gson gson) {
    return new AutoValue_UpscaleImageAPIConfig.GsonTypeAdapter(gson);
  }
