 ...
 */
@AutoValue
@JsonDeserialize(builder = GoogleMapsPlaces.Builder.class)
public abstract class GoogleMapsPlaces extends JsonSerializable {
  /** Instantiates a builder for GoogleMapsPlaces. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_GoogleMapsPlaces.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for GoogleMapsPlaces. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `GoogleMapsPlaces.builder()` for instantiation. */
    @JsonCreator
    private static Builder create() {
      return new AutoValue_GoogleMapsPlaces.Builder();
    }

    public abstract GoogleMapsPlaces build();
  }
