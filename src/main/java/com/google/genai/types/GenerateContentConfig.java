...
public abstract class GenerateContentConfig extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("systemInstruction")
    public abstract Builder systemInstruction(Optional<Content> systemInstruction);

    @SerializedName("temperature")
    public abstract Builder temperature(Float temperature);

    @SerializedName("temperature")
    public abstract Builder temperature(Optional<Float> temperature);

    @SerializedName("topP")
    public abstract Builder topP(Float topP);

    @SerializedName("topP")
    public abstract Builder topP(Optional<Float> topP);

    @SerializedName("topK")
    public abstract Builder topK(Float topK);

    @SerializedName("topK")
    public abstract Builder topK(Optional<Float> topK);

    @SerializedName("candidateCount")
    public abstract Builder candidateCount(Integer candidateCount);

    @SerializedName("candidateCount")
    public abstract Builder candidateCount(Optional<Integer> candidateCount);

    @SerializedName("maxOutputTokens")
    public abstract Builder maxOutputTokens(Integer maxOutputTokens);

    @SerializedName("maxOutputTokens")
    public abstract Builder maxOutputTokens(Optional<Integer> maxOutputTokens);

    @SerializedName("stopSequences")
    public abstract Builder stopSequences(List<String> stopSequences);

    @SerializedName("stopSequences")
    public abstract Builder stopSequences(Optional<List<String>> stopSequences);

    @SerializedName("responseLogprobs")
    public abstract Builder responseLogprobs(boolean responseLogprobs);

    @SerializedName("responseLogprobs")
    public abstract Builder responseLogprobs(Optional<Boolean> responseLogprobs);

    @SerializedName("logprobs")
    public abstract Builder logprobs(Integer logprobs);

    @SerializedName("logprobs")
    public abstract Builder logprobs(Optional<Integer> logprobs);

    @SerializedName("presencePenalty")
    public abstract Builder presencePenalty(Float presencePenalty);

    @SerializedName("presencePenalty")
    public abstract Builder presencePenalty(Optional<Float> presencePenalty);

    @SerializedName("frequencyPenalty")
    public abstract Builder frequencyPenalty(Float frequencyPenalty);

    @SerializedName("frequencyPenalty")
    public abstract Builder frequencyPenalty(Optional<Float> frequencyPenalty);
    ...
    @SerializedName("responseMimeType")
    public abstract Builder responseMimeType(Optional<String> responseMimeType);

    @SerializedName("responseSchema")
    public abstract Builder responseSchema(Schema responseSchema);

    @SerializedName("responseSchema")
    public abstract Builder responseSchema(Optional<Schema> responseSchema);

    @SerializedName("routingConfig")
    public abstract Builder routingConfig(GenerationConfigRoutingConfig routingConfig);

    @SerializedName("routingConfig")
    public abstract Builder routingConfig(Optional<GenerationConfigRoutingConfig> routingConfig);

    @SerializedName("safetySettings")
    public abstract Builder safetySettings(List<SafetySetting> safetySettings);

    @SerializedName("safetySettings")
    public abstract Builder safetySettings(Optional<List<SafetySetting>> safetySettings);

    @SerializedName("tools")
    public abstract Builder tools(List<Tool> tools);

    @SerializedName("tools")
    public abstract Builder tools(Optional<List<Tool>> tools);

    @SerializedName("toolConfig")
    public abstract Builder toolConfig(ToolConfig toolConfig);

    @SerializedName("toolConfig")
    public abstract Builder toolConfig(Optional<ToolConfig> toolConfig);

    @SerializedName("labels")
    public abstract Builder labels(Map<String, String> labels);

    @SerializedName("labels")
    public abstract Builder labels(Optional<Map<String, String>> labels);

    @SerializedName("cachedContent")
    public abstract Builder cachedContent(String cachedContent);

    @SerializedName("cachedContent")
    public abstract Builder cachedContent(Optional<String> cachedContent);

    @SerializedName("responseModalities")
    public abstract Builder responseModalities(List<String> responseModalities);

    @SerializedName("responseModalities")
    public abstract Builder responseModalities(Optional<List<String>> responseModalities);

    @SerializedName("mediaResolution")
    public abstract Builder mediaResolution(String mediaResolution);

    @SerializedName("mediaResolution")
    public abstract Builder mediaResolution(Optional<String> mediaResolution);

    @SerializedName("speechConfig")
    public abstract Builder speechConfig(SpeechConfig speechConfig);

    @SerializedName("speechConfig")
    public abstract Builder speechConfig(Optional<SpeechConfig> speechConfig);

    @SerializedName("audioTimestamp")
    public abstract Builder audioTimestamp(boolean audioTimestamp);

    @SerializedName("audioTimestamp")
    public abstract Builder audioTimestamp(Optional<Boolean> audioTimestamp);

    @SerializedName("thinkingConfig")
    public abstract Builder thinkingConfig(ThinkingConfig thinkingConfig);

    @SerializedName("thinkingConfig")
    public abstract Builder thinkingConfig(Optional<ThinkingConfig> thinkingConfig);

    public abstract GenerateContentConfig build();
  }

  /** Returns a TypeAdapter for GenerateContentConfig. */
  public static TypeAdapter<GenerateContentConfig> typeAdapter(Gson gson) {
    return new AutoValue_GenerateContentConfig.GsonTypeAdapter(gson);
  }
