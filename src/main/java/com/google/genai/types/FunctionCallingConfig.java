...
public abstract class FunctionCallingConfig extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("allowedFunctionNames")
    public abstract Builder allowedFunctionNames(Optional<List<String>> allowedFunctionNames);

    public abstract FunctionCallingConfig build();
  }

  /** Returns a TypeAdapter for FunctionCallingConfig. */
  public static TypeAdapter<FunctionCallingConfig> typeAdapter(Gson gson) {
    return new AutoValue_FunctionCallingConfig.GsonTypeAdapter(gson);
  }
