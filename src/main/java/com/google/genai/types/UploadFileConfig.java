...
public abstract class UploadFileConfig extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("displayName")
    public abstract Builder displayName(Optional<String> displayName);

    public abstract UploadFileConfig build();
  }

  /** Returns a TypeAdapter for UploadFileConfig. */
  public static TypeAdapter<UploadFileConfig> typeAdapter(Gson gson) {
    return new AutoValue_UploadFileConfig.GsonTypeAdapter(gson);
  }
