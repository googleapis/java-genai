...
@AutoValue
@JsonDeserialize(builder = ExactMatchMetricValue.Builder.class)
public abstract class ExactMatchMetricValue extends JsonSerializable {
  ...
  public static Builder builder() {
    return new AutoValue_ExactMatchMetricValue.Builder();
  }
  ...
  public abstract static class Builder {
    /** For internal usage. Please use `ExactMatchMetricValue.builder()` for instantiation. */
    @JsonCreator
     ...
     * Setter for score.
     *
     * <p>score: Output only. Exact match score.
     */
    @JsonProperty("score")
    ...
    public abstract ExactMatchMetricValue build();
  }

  /** Deserializes a JSON string to a ExactMatchMetricValue object. */
  @ExcludeFromGeneratedCoverageReport
  public static ExactMatchMetricValue fromJson(String jsonString) {
    return Common.fromJsonString(jsonString, ExactMatchMetricValue.class);
  }
}
