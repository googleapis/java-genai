...
public abstract class ReplayFile extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("replayId")
    public abstract Builder replayId(Optional<String> replayId);

    @SerializedName("interactions")
    public abstract Builder interactions(List<ReplayInteraction> interactions);

    @SerializedName("interactions")
    public abstract Builder interactions(Optional<List<ReplayInteraction>> interactions);

    public abstract ReplayFile build();
  }

  /** Returns a TypeAdapter for ReplayFile. */
  public static TypeAdapter<ReplayFile> typeAdapter(Gson gson) {
    return new AutoValue_ReplayFile.GsonTypeAdapter(gson);
  }
