...
public abstract class SafetyRating extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("blocked")
    public abstract Builder blocked(Optional<Boolean> blocked);
    ...
    @SerializedName("probability")
    public abstract Builder probability(Optional<String> probability);

    @SerializedName("probabilityScore")
    public abstract Builder probabilityScore(Float probabilityScore);

    @SerializedName("probabilityScore")
    public abstract Builder probabilityScore(Optional<Float> probabilityScore);

    @SerializedName("severity")
    public abstract Builder severity(String severity);

    @SerializedName("severity")
    public abstract Builder severity(Optional<String> severity);

    @SerializedName("severityScore")
    public abstract Builder severityScore(Float severityScore);

    @SerializedName("severityScore")
    public abstract Builder severityScore(Optional<Float> severityScore);

    public abstract SafetyRating build();
  }

  /** Returns a TypeAdapter for SafetyRating. */
  public static TypeAdapter<SafetyRating> typeAdapter(Gson gson) {
    return new AutoValue_SafetyRating.GsonTypeAdapter(gson);
  }
