...
public abstract class VideoMetadata extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("endOffset")
    public abstract Builder endOffset(Optional<String> endOffset);

    @SerializedName("startOffset")
    public abstract Builder startOffset(String startOffset);

    @SerializedName("startOffset")
    public abstract Builder startOffset(Optional<String> startOffset);

    public abstract VideoMetadata build();
  }

  /** Returns a TypeAdapter for VideoMetadata. */
  public static TypeAdapter<VideoMetadata> typeAdapter(Gson gson) {
    return new AutoValue_VideoMetadata.GsonTypeAdapter(gson);
  }
