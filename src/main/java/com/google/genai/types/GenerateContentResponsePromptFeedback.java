...
public abstract class GenerateContentResponsePromptFeedback extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("blockReason")
    public abstract Builder blockReason(Optional<String> blockReason);

    @SerializedName("blockReasonMessage")
    public abstract Builder blockReasonMessage(String blockReasonMessage);

    @SerializedName("blockReasonMessage")
    public abstract Builder blockReasonMessage(Optional<String> blockReasonMessage);
  ...
  /** Returns a TypeAdapter for GenerateContentResponsePromptFeedback. */
  public static TypeAdapter<GenerateContentResponsePromptFeedback> typeAdapter(Gson gson) {
    return new AutoValue_GenerateContentResponsePromptFeedback.GsonTypeAdapter(gson);
  }
