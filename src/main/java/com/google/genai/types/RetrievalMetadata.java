...
public abstract class RetrievalMetadata extends JsonSerializable {
  ...
  /** Returns a TypeAdapter for RetrievalMetadata. */
  public static TypeAdapter<RetrievalMetadata> typeAdapter(Gson gson) {
    return new AutoValue_RetrievalMetadata.GsonTypeAdapter(gson);
  }
