...
@AutoValue
@JsonDeserialize(builder = DeleteDocumentConfig.Builder.class)
public abstract class DeleteDocumentConfig extends JsonSerializable {
  ...
  public static Builder builder() {
    return new AutoValue_DeleteDocumentConfig.Builder();
  }
  ...
  public abstract static class Builder {
    /** For internal usage. Please use `DeleteDocumentConfig.builder()` for instantiation. */
    @JsonCreator
     ...
     * Setter for force.
     *
     * <p>force: If set to true, any `Chunk`s and objects related to this `Document` will also be
     * deleted.
     */
    @JsonProperty("force")
