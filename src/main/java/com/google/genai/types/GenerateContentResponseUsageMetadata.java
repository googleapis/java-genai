...
public abstract class GenerateContentResponseUsageMetadata extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("cachedContentTokenCount")
    public abstract Builder cachedContentTokenCount(Optional<Integer> cachedContentTokenCount);

    @SerializedName("candidatesTokenCount")
    public abstract Builder candidatesTokenCount(Integer candidatesTokenCount);

    @SerializedName("candidatesTokenCount")
    public abstract Builder candidatesTokenCount(Optional<Integer> candidatesTokenCount);

    @SerializedName("promptTokenCount")
    public abstract Builder promptTokenCount(Integer promptTokenCount);

    @SerializedName("promptTokenCount")
    public abstract Builder promptTokenCount(Optional<Integer> promptTokenCount);

    @SerializedName("totalTokenCount")
    public abstract Builder totalTokenCount(Integer totalTokenCount);

    @SerializedName("totalTokenCount")
    public abstract Builder totalTokenCount(Optional<Integer> totalTokenCount);

    public abstract GenerateContentResponseUsageMetadata build();
  }

  /** Returns a TypeAdapter for GenerateContentResponseUsageMetadata. */
  public static TypeAdapter<GenerateContentResponseUsageMetadata> typeAdapter(Gson gson) {
    return new AutoValue_GenerateContentResponseUsageMetadata.GsonTypeAdapter(gson);
  }
