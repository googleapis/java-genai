...
public abstract class CustomCodeExecutionSpec extends JsonSerializable {
   ...
   * region where the Code Execution Sandbox is available. Supported regions:
   * northamerica-northeast1, southamerica-east1, us-central1, us-east1, us-east4, us-west1,
   * us-west4, europe-central2, europe-north1, europe-southwest1, europe-west1, europe-west2,
   * europe-west3, europe-west4, europe-west6, europe-west8, europe-west9, me-west1, asia-east1,
   * asia-east2, asia-northeast1, asia-northeast3, asia-south1, asia-south2, asia-southeast1,
   * australia-southeast2. If unset, the request's originating region is used; requests from regions
   * where the sandbox is unavailable will fail with UNIMPLEMENTED.
   */
  ...
  public abstract static class Builder {
     ...
     * regions: northamerica-northeast1, southamerica-east1, us-central1, us-east1, us-east4,
     * us-west1, us-west4, europe-central2, europe-north1, europe-southwest1, europe-west1,
     * europe-west2, europe-west3, europe-west4, europe-west6, europe-west8, europe-west9, me-west1,
     * asia-east1, asia-east2, asia-northeast1, asia-northeast3, asia-south1, asia-south2,
     * asia-southeast1, australia-southeast2. If unset, the request's originating region is used;
     * requests from regions where the sandbox is unavailable will fail with UNIMPLEMENTED.
     */
    @JsonProperty("codeExecutionRegion")
