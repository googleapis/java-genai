 ...
 *
 * <p>The specification for an output Vertex AI multimodal dataset.
 */
@AutoValue
@JsonDeserialize(builder = VertexMultimodalDatasetDestination.Builder.class)
public abstract class VertexMultimodalDatasetDestination extends JsonSerializable {
  ...
  public static Builder builder() {
    return new AutoValue_VertexMultimodalDatasetDestination.Builder();
  }
  ...
  public abstract static class Builder {
    /**
     * For internal usage. Please use `VertexMultimodalDatasetDestination.builder()` for
     * instantiation.
     */
    @JsonCreator
     ...
     *
     * <p>bigqueryDestination: The BigQuery destination for the multimodal dataset.
     */
    @JsonProperty("bigqueryDestination")
    ...
    public abstract VertexMultimodalDatasetDestination build();
  }

  /** Deserializes a JSON string to a VertexMultimodalDatasetDestination object. */
  @ExcludeFromGeneratedCoverageReport
  public static VertexMultimodalDatasetDestination fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, VertexMultimodalDatasetDestination.class);
  }
}
