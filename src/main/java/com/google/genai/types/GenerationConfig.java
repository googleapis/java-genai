...
public abstract class GenerationConfig extends JsonSerializable {
  ...
  /** Returns a TypeAdapter for GenerationConfig. */
  public static TypeAdapter<GenerationConfig> typeAdapter(Gson gson) {
    return new AutoValue_GenerationConfig.GsonTypeAdapter(gson);
  }
