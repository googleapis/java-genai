...
public abstract class GroundingMetadata extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("groundingChunks")
    public abstract Builder groundingChunks(Optional<List<GroundingChunk>> groundingChunks);

    @SerializedName("groundingSupports")
    public abstract Builder groundingSupports(List<GroundingSupport> groundingSupports);

    @SerializedName("groundingSupports")
    public abstract Builder groundingSupports(Optional<List<GroundingSupport>> groundingSupports);

    @SerializedName("retrievalMetadata")
    public abstract Builder retrievalMetadata(RetrievalMetadata retrievalMetadata);

    @SerializedName("retrievalMetadata")
    public abstract Builder retrievalMetadata(Optional<RetrievalMetadata> retrievalMetadata);

    @SerializedName("retrievalQueries")
    public abstract Builder retrievalQueries(List<String> retrievalQueries);

    @SerializedName("retrievalQueries")
    public abstract Builder retrievalQueries(Optional<List<String>> retrievalQueries);

    @SerializedName("searchEntryPoint")
    public abstract Builder searchEntryPoint(SearchEntryPoint searchEntryPoint);

    @SerializedName("searchEntryPoint")
    public abstract Builder searchEntryPoint(Optional<SearchEntryPoint> searchEntryPoint);

    @SerializedName("webSearchQueries")
    public abstract Builder webSearchQueries(List<String> webSearchQueries);

    @SerializedName("webSearchQueries")
    public abstract Builder webSearchQueries(Optional<List<String>> webSearchQueries);

    public abstract GroundingMetadata build();
  }

  /** Returns a TypeAdapter for GroundingMetadata. */
  public static TypeAdapter<GroundingMetadata> typeAdapter(Gson gson) {
    return new AutoValue_GroundingMetadata.GsonTypeAdapter(gson);
  }
