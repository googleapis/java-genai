...
public abstract class UpscaleImageAPIParameters extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("model")
    public abstract Builder model(Optional<String> model);

    @SerializedName("image")
    public abstract Builder image(Image image);

    @SerializedName("image")
    public abstract Builder image(Optional<Image> image);

    @SerializedName("upscaleFactor")
    public abstract Builder upscaleFactor(String upscaleFactor);

    @SerializedName("upscaleFactor")
    public abstract Builder upscaleFactor(Optional<String> upscaleFactor);

    @SerializedName("config")
    public abstract Builder config(UpscaleImageAPIConfig config);

    @SerializedName("config")
    public abstract Builder config(Optional<UpscaleImageAPIConfig> config);

    public abstract UpscaleImageAPIParameters build();
  }

  /** Returns a TypeAdapter for UpscaleImageAPIParameters. */
  public static TypeAdapter<UpscaleImageAPIParameters> typeAdapter(Gson gson) {
    return new AutoValue_UpscaleImageAPIParameters.GsonTypeAdapter(gson);
  }
