...
public abstract class Part extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("videoMetadata")
    public abstract Builder videoMetadata(Optional<VideoMetadata> videoMetadata);

    @SerializedName("thought")
    public abstract Builder thought(boolean thought);

    @SerializedName("thought")
    public abstract Builder thought(Optional<Boolean> thought);

    @SerializedName("codeExecutionResult")
    public abstract Builder codeExecutionResult(CodeExecutionResult codeExecutionResult);

    @SerializedName("codeExecutionResult")
    public abstract Builder codeExecutionResult(Optional<CodeExecutionResult> codeExecutionResult);

    @SerializedName("executableCode")
    public abstract Builder executableCode(ExecutableCode executableCode);

    @SerializedName("executableCode")
    public abstract Builder executableCode(Optional<ExecutableCode> executableCode);

    @SerializedName("fileData")
    public abstract Builder fileData(FileData fileData);

    @SerializedName("fileData")
    public abstract Builder fileData(Optional<FileData> fileData);

    @SerializedName("functionCall")
    public abstract Builder functionCall(FunctionCall functionCall);

    @SerializedName("functionCall")
    public abstract Builder functionCall(Optional<FunctionCall> functionCall);

    @SerializedName("functionResponse")
    public abstract Builder functionResponse(FunctionResponse functionResponse);

    @SerializedName("functionResponse")
    public abstract Builder functionResponse(Optional<FunctionResponse> functionResponse);

    @SerializedName("inlineData")
    public abstract Builder inlineData(Blob inlineData);

    @SerializedName("inlineData")
    public abstract Builder inlineData(Optional<Blob> inlineData);
  ...
  /** Returns a TypeAdapter for Part. */
  public static TypeAdapter<Part> typeAdapter(Gson gson) {
    return new AutoValue_Part.GsonTypeAdapter(gson);
  }
