...
public abstract class Part extends JsonSerializable {
  ...
  public abstract static class Builder {
     ...
     *
     * <p>codeExecutionResult: Optional. The result of executing the ExecutableCode.
     */
    @JsonProperty("codeExecutionResult")
     ...
     *
     * <p>executableCode: Optional. Code generated by the model that is intended to be executed.
     */
    @JsonProperty("executableCode")
     ...
     * Setter for fileData.
     *
     * <p>fileData: Optional. The URI-based data of the part. This can be used to include files from
     ...
     *
     * <p>functionCall: Optional. A predicted function call returned from the model. This contains
     ...
     *
     * <p>functionResponse: Optional. The result of a function call. This is used to provide the
     ...
     *
     * <p>inlineData: Optional. The inline data content of the part. This can be used to include
     ...
     * Setter for text.
     *
     * <p>text: Optional. The text content of the part. When sent from the VSCode Gemini Code Assist
     * extension, references to @mentioned items will be converted to markdown boldface text. For
     * example `@my-repo` will be converted to and sent as `**my-repo**` by the IDE agent.
     */
    @JsonProperty("text")
     ...
     * Setter for thought.
     *
     * <p>thought: Optional. Indicates whether the `part` represents the model's thought process or
     * reasoning.
     */
    @JsonProperty("thought")
