...
public abstract class ReplayRequest extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("method")
    public abstract Builder method(Optional<String> method);
  ...
  /** Returns a TypeAdapter for ReplayRequest. */
  public static TypeAdapter<ReplayRequest> typeAdapter(Gson gson) {
    return new AutoValue_ReplayRequest.GsonTypeAdapter(gson);
  }
