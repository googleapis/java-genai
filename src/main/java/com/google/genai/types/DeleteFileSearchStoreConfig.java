...
@AutoValue
@JsonDeserialize(builder = DeleteFileSearchStoreConfig.Builder.class)
public abstract class DeleteFileSearchStoreConfig extends JsonSerializable {
   ...
   * If false (the default), a FAILED_PRECONDITION error will be returned if the FileSearchStore
  ...
  public static Builder builder() {
    return new AutoValue_DeleteFileSearchStoreConfig.Builder();
  }
  ...
  public abstract static class Builder {
    /** For internal usage. Please use `DeleteFileSearchStoreConfig.builder()` for instantiation. */
    @JsonCreator
     ...
     * Setter for force.
     *
     * <p>force: If set to true, any Documents and objects related to this FileSearchStore will also
     * be deleted. If false (the default), a FAILED_PRECONDITION error will be returned if the
     * FileSearchStore contains any Documents.
     */
    @JsonProperty("force")
    ...
    public abstract DeleteFileSearchStoreConfig build();
  }
  ...
  public static DeleteFileSearchStoreConfig fromJson(String jsonString) {
    return Common.fromJsonString(jsonString, DeleteFileSearchStoreConfig.class);
  }
}
