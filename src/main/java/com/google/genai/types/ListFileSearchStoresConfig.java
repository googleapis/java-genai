...
@AutoValue
@JsonDeserialize(builder = ListFileSearchStoresConfig.Builder.class)
public abstract class ListFileSearchStoresConfig extends JsonSerializable {
  ...
  public static Builder builder() {
    return new AutoValue_ListFileSearchStoresConfig.Builder();
  }
  ...
  public abstract static class Builder {
    /** For internal usage. Please use `ListFileSearchStoresConfig.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract ListFileSearchStoresConfig build();
  }

  /** Deserializes a JSON string to a ListFileSearchStoresConfig object. */
  @ExcludeFromGeneratedCoverageReport
  public static ListFileSearchStoresConfig fromJson(String jsonString) {
    return Common.fromJsonString(jsonString, ListFileSearchStoresConfig.class);
  }
}
