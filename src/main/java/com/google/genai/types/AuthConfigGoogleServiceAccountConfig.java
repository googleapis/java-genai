...
public abstract class AuthConfigGoogleServiceAccountConfig extends JsonSerializable {
  ...
  public abstract static class Builder {
     ...
     *
     * <p>serviceAccount: Optional. The service account that the extension execution service runs
     * as. - If the service account is specified, the `iam.serviceAccounts.getAccessToken`
  ...
  public static AuthConfigGoogleServiceAccountConfig fromJson(String jsonString) {
    return Common.fromJsonString(jsonString, AuthConfigGoogleServiceAccountConfig.class);
  }
}
