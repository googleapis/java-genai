...
public abstract class LiveServerSessionResumptionUpdate extends JsonSerializable {
   ...
   * messages sent since last `SessionResumptionTokenUpdate`. This field will enable them to limit
   ...
   * cases partial audio and video frames are likely not needed.
   */
  ...
  public static LiveServerSessionResumptionUpdate fromJson(String jsonString) {
    return Common.fromJsonString(jsonString, LiveServerSessionResumptionUpdate.class);
  }
}
