...
public abstract class ThinkingConfig extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("includeThoughts")
    public abstract Builder includeThoughts(Optional<Boolean> includeThoughts);

    public abstract ThinkingConfig build();
  }

  /** Returns a TypeAdapter for ThinkingConfig. */
  public static TypeAdapter<ThinkingConfig> typeAdapter(Gson gson) {
    return new AutoValue_ThinkingConfig.GsonTypeAdapter(gson);
  }
