...
public abstract class Candidate extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("citationMetadata")
    public abstract Builder citationMetadata(Optional<CitationMetadata> citationMetadata);

    @SerializedName("finishMessage")
    public abstract Builder finishMessage(String finishMessage);

    @SerializedName("finishMessage")
    public abstract Builder finishMessage(Optional<String> finishMessage);

    @SerializedName("tokenCount")
    public abstract Builder tokenCount(Integer tokenCount);

    @SerializedName("tokenCount")
    public abstract Builder tokenCount(Optional<Integer> tokenCount);
    ...
    @SerializedName("finishReason")
    public abstract Builder finishReason(Optional<String> finishReason);
    ...
    @SerializedName("index")
    public abstract Builder index(Optional<Integer> index);

    @SerializedName("logprobsResult")
    public abstract Builder logprobsResult(LogprobsResult logprobsResult);

    @SerializedName("logprobsResult")
    public abstract Builder logprobsResult(Optional<LogprobsResult> logprobsResult);

    @SerializedName("safetyRatings")
    public abstract Builder safetyRatings(List<SafetyRating> safetyRatings);

    @SerializedName("safetyRatings")
    public abstract Builder safetyRatings(Optional<List<SafetyRating>> safetyRatings);

    public abstract Candidate build();
  }

  /** Returns a TypeAdapter for Candidate. */
  public static TypeAdapter<Candidate> typeAdapter(Gson gson) {
    return new AutoValue_Candidate.GsonTypeAdapter(gson);
  }
