...
public abstract class FunctionDeclaration extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @SerializedName("response")
    public abstract Builder response(Optional<Schema> response);
    ...
    @SerializedName("parameters")
    public abstract Builder parameters(Optional<Schema> parameters);

    public abstract FunctionDeclaration build();
  }

  /** Returns a TypeAdapter for FunctionDeclaration. */
  public static TypeAdapter<FunctionDeclaration> typeAdapter(Gson gson) {
    return new AutoValue_FunctionDeclaration.GsonTypeAdapter(gson);
  }
