...
public abstract class ToolCodeExecution extends JsonSerializable {
  ...
  /** Returns a TypeAdapter for ToolCodeExecution. */
  public static TypeAdapter<ToolCodeExecution> typeAdapter(Gson gson) {
    return new AutoValue_ToolCodeExecution.GsonTypeAdapter(gson);
  }
