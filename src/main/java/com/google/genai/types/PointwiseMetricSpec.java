...
@AutoValue
@JsonDeserialize(builder = PointwiseMetricSpec.Builder.class)
public abstract class PointwiseMetricSpec extends JsonSerializable {
  ...
  public static Builder builder() {
    return new AutoValue_PointwiseMetricSpec.Builder();
  }
  ...
  public abstract static class Builder {
    /** For internal usage. Please use `PointwiseMetricSpec.builder()` for instantiation. */
    @JsonCreator
     ...
     *
     * <p>metricPromptTemplate: Required. Metric prompt template for pointwise metric.
     */
    @JsonProperty("metricPromptTemplate")
     ...
     * metric output. By default, metrics return a score and explanation. When this config is set,
     * the default output is replaced with either: - The raw output string. - A parsed output based
     * on a user-defined schema. If a custom format is chosen, the `score` and `explanation` fields
     * in the corresponding metric result will be empty.
     */
    @JsonProperty("customOutputFormatConfig")
     ...
     *
     * <p>systemInstruction: Optional. System instructions for pointwise metric.
     */
    @JsonProperty("systemInstruction")
