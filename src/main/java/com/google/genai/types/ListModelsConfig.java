...
public abstract class ListModelsConfig extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @ExcludeFromGeneratedCoverageReport
    abstract Builder queryBase(Optional<Boolean> queryBase);

    /** Clears the value of queryBase field. */
    @ExcludeFromGeneratedCoverageReport
    @CanIgnoreReturnValue
    public Builder clearQueryBase() {
      return queryBase(Optional.empty());
    }
  ...
  public static ListModelsConfig fromJson(String jsonString) {
    return Common.fromJsonString(jsonString, ListModelsConfig.class);
  }
}
