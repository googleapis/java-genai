...
public abstract class GroundingChunkWeb extends JsonSerializable {
  ...
  /** Returns a TypeAdapter for GroundingChunkWeb. */
  public static TypeAdapter<GroundingChunkWeb> typeAdapter(Gson gson) {
    return new AutoValue_GroundingChunkWeb.GsonTypeAdapter(gson);
  }
