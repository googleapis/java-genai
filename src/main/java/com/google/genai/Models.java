...
public final class Models {
  ...
  @ExcludeFromGeneratedCoverageReport
  void thinkingLevelVertexEnumValidate(Object enumValue) {
    ImmutableSet<String> invalidEnumValues = ImmutableSet.of("MINIMAL", "MEDIUM");
    if (invalidEnumValues.contains(enumValue.toString().replace("\"", ""))) {
      throw new IllegalArgumentException(
  ...
  ObjectNode thinkingConfigToVertex(JsonNode fromObject, ObjectNode parentObject) {
    ...
    if (Common.getValueByPath(fromObject, new String[] {"thinkingLevel"}) != null) {
      thinkingLevelVertexEnumValidate(
