...
public class Webhooks {
   ...
   *     fewer than this value. If unspecified, at most 50 webhooks will be returned. The maximum
   *     value is 1000.
   * @param pageToken Optional. A page token, received from a previous `ListWebhooks` call. Provide
   ...
   * Deletes a Webhook.
   *
   * @param id Required. The ID of the webhook to delete. Format: `{webhook_id}`
   * @return The response from the API call
   * @throws RuntimeException subclass if the API call fails
   */
   ...
   * Generates a new signing secret for a Webhook.
   *
   * @param id Required. The ID of the webhook for which to generate a signing secret. Format:
   *     `{webhook_id}`
   * @return The response from the API call
   * @throws RuntimeException subclass if the API call fails
   */
  ...
  public RotateSigningSecretResponse rotateSigningSecret(
    ...
    com.google.genai.gaos.models.operations.RotateSigningSecretRequest request =
        new com.google.genai.gaos.models.operations.RotateSigningSecretRequest(
            apiVersion, id, body);
    RequestOperation<
            com.google.genai.gaos.models.operations.RotateSigningSecretRequest,
            RotateSigningSecretResponse>
        operation = new RotateSigningSecret.Sync(sdkConfiguration, options, _headers);
    return operation.handleResponse(operation.doRequest(request));
  }
   ...
   * Sends a ping event to a Webhook.
   *
   * @param id Required. The ID of the webhook to ping. Format: `{webhook_id}`
   * @return The response from the API call
   * @throws RuntimeException subclass if the API call fails
   */
  ...
  public PingWebhookResponse ping(
    ...
    RequestOperation<
            com.google.genai.gaos.models.operations.PingWebhookRequest, PingWebhookResponse>
        operation = new PingWebhook.Sync(sdkConfiguration, options, _headers);
    return operation.handleResponse(operation.doRequest(request));
  }
}
