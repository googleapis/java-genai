...
/**
 * Gemini API: The Gemini Interactions API allows developers to build generative AI applications
 * using Gemini models. Gemini is our most capable model, built from the ground up to be multimodal.
 *
 * <p>It can generalize and seamlessly understand, operate across, and combine different types of
 * information including language, images, audio, video, and code. You can use the Gemini API for
 * use cases like reasoning across text and images, content generation, dialogue agents,
...
public class GenAI {
  ...
  public static class Builder {
     ...
     */
    public GenAI build() {
      if (serverUrl == null || Java8Compat.isBlank(serverUrl)) {
        serverUrl = SERVERS[0];
