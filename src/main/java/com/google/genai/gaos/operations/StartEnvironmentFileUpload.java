...
public class StartEnvironmentFileUpload {
    ...
    public static class Sync extends Base
            implements RequestOperation<StartEnvironmentFileUploadRequest, StartEnvironmentFileUploadResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StartEnvironmentFileUploadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartEnvironmentFileUploadRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StartEnvironmentFileUploadRequest request) {
        ...
        @Override
        public StartEnvironmentFileUploadResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .contentType()
                    .orElse("application/octet-stream");
            StartEnvironmentFileUploadResponse.Builder resBuilder =
            ...
            StartEnvironmentFileUploadResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StartEnvironmentFileUploadRequest, com.google.genai.gaos.models.operations.async.StartEnvironmentFileUploadResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StartEnvironmentFileUploadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartEnvironmentFileUploadRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<InputStream>> doRequest(StartEnvironmentFileUploadRequest request) {
        ...
        @Override
        public com.google.genai.gaos.models.operations.async.StartEnvironmentFileUploadResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .contentType()
                    .orElse("application/octet-stream");
            com.google.genai.gaos.models.operations.async.StartEnvironmentFileUploadResponse.Builder resBuilder =
                    com.google.genai.gaos.models.operations.async.StartEnvironmentFileUploadResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.google.genai.gaos.models.operations.async.StartEnvironmentFileUploadResponse res = resBuilder.build();
