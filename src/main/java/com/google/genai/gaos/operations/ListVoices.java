...
public class ListVoices {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListVoicesRequest, ListVoicesResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListVoicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVoicesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListVoicesRequest request) {
        ...
        @Override
        public ListVoicesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .contentType()
                    .orElse("application/octet-stream");
            ListVoicesResponse.Builder resBuilder =
                    ListVoicesResponse
                            .builder()
            ...
            ListVoicesResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "default")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListVoicesResponse(Utils.unmarshal(response, new TypeReference<com.google.genai.gaos.models.voices.ListVoicesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListVoicesRequest, com.google.genai.gaos.models.operations.async.ListVoicesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListVoicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVoicesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<InputStream>> doRequest(ListVoicesRequest request) {
        ...
        @Override
        public com.google.genai.gaos.models.operations.async.ListVoicesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .contentType()
                    .orElse("application/octet-stream");
            com.google.genai.gaos.models.operations.async.ListVoicesResponse.Builder resBuilder =
                    com.google.genai.gaos.models.operations.async.ListVoicesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.google.genai.gaos.models.operations.async.ListVoicesResponse res = resBuilder.build();
