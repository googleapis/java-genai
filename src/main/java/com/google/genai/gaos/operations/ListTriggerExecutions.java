...
public class ListTriggerExecutions {
    ...
    public static class Sync extends Base
        ...
        public ListTriggerExecutionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListTriggerExecutionsResponse.Builder resBuilder = ListTriggerExecutionsResponse.builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListTriggerExecutionsResponse(Utils.unmarshal(
                            response,
                            new TypeReference<com.google.genai.gaos.models.triggers.ListTriggerExecutionsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        @Override
        public com.google.genai.gaos.models.operations.async.ListTriggerExecutionsResponse handleResponse(
