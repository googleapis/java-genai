...
public class ListTriggerExecutions {
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<HttpResponse<InputStream>> doRequest(ListTriggerExecutionsRequest request) {
        ...
        @Override
        public com.google.genai.gaos.models.operations.async.ListTriggerExecutionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .contentType()
                    .orElse("application/octet-stream");
