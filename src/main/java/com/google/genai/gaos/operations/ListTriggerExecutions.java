...
public class ListTriggerExecutions {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTriggerExecutionsRequest, ListTriggerExecutionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListTriggerExecutionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTriggerExecutionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTriggerExecutionsRequest request) {
        ...
        @Override
        public ListTriggerExecutionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTriggerExecutionsResponse.Builder resBuilder =
            ...
            ListTriggerExecutionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListTriggerExecutionsResponse(Utils.unmarshal(response, new TypeReference<com.google.genai.gaos.models.triggers.ListTriggerExecutionsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTriggerExecutionsRequest, com.google.genai.gaos.models.operations.async.ListTriggerExecutionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListTriggerExecutionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTriggerExecutionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTriggerExecutionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.google.genai.gaos.models.operations.async.ListTriggerExecutionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.google.genai.gaos.models.operations.async.ListTriggerExecutionsResponse.Builder resBuilder =
            ...
            com.google.genai.gaos.models.operations.async.ListTriggerExecutionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.google.genai.gaos.models.triggers.ListTriggerExecutionsResponse>() {})
                            .thenApply(res::withListTriggerExecutionsResponse);
                } else {
