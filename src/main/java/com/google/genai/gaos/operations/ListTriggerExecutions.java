...
public class ListTriggerExecutions {
  ...
  public static class Sync extends Base
    ...
    public ListTriggerExecutionsResponse handleResponse(HttpResponse<InputStream> response) {
      ...
      ListTriggerExecutionsResponse.Builder resBuilder =
          ListTriggerExecutionsResponse.builder()
      ...
      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          return res.withListTriggerExecutionsResponse(
              Utils.unmarshal(
                  response,
                  new TypeReference<
  ...
  public static class Async extends Base
    ...
    private CompletableFuture<HttpRequest> onBuildRequest(ListTriggerExecutionsRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, ListTriggerExecutionsRequest.class);
    ...
    @Override
    public com.google.genai.gaos.models.operations.async.ListTriggerExecutionsResponse
        handleResponse(HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      ...
      com.google.genai.gaos.models.operations.async.ListTriggerExecutionsResponse res =
          resBuilder.build();
