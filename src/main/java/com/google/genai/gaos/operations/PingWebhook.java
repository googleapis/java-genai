...
public class PingWebhook {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    this.sdkConfiguration, this.baseUrl, "PingWebhook", java.util.Optional.empty(), securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/{api_version}/webhooks/{id}:ping", request, this.operationGlobals);
    ...
    public static class Sync extends Base implements RequestOperation<PingWebhookRequest, PingWebhookResponse> {
        ...
        private HttpRequest onBuildRequest(PingWebhookRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, PingWebhookRequest.class, new TypeReference<PingWebhookRequest>() {});
        ...
        public PingWebhookResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            PingWebhookResponse.Builder resBuilder = PingWebhookResponse.builder()
