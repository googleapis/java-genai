...
import com.google.genai.gaos.models.webhooks.WebhookPingResponse;
...
public class PingWebhook {
  ...
  abstract static class Base {
    ...
    public Base(
        @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options, Headers _headers) {
      ...
      this.retryConfig =
          Java8Compat.or(
                  Optional.ofNullable(options).flatMap(Options::retryConfig),
                  sdkConfiguration::retryConfig)
              .orElse(
                  RetryConfig.builder()
                      .attemptCountBackoff(
                          4,
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
        throws Exception {
      String url =
          Utils.generateURL(
              klass,
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "body", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<PingWebhookRequest, PingWebhookResponse> {
    public Sync(
        @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options, Headers _headers) {
      super(sdkConfiguration, options, _headers);
    }

    private HttpRequest onBuildRequest(PingWebhookRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request, PingWebhookRequest.class, new TypeReference<PingWebhookRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(PingWebhookRequest request) {
      Retries retries =
          Retries.builder()
              .action(
                  (attempt) -> {
    ...
    @Override
    public PingWebhookResponse handleResponse(HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      PingWebhookResponse.Builder resBuilder =
          PingWebhookResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      PingWebhookResponse res = resBuilder.build();
      ...
      if (Utils.statusCodeMatches(response.statusCode(), "default")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          return res.withWebhookPingResponse(
              Utils.unmarshal(response, new TypeReference<WebhookPingResponse>() {}));
        } else {
          throw SDKException.from("Unexpected content-type received: " + contentType, response);
        }
      }
      throw SDKException.from(
          "Unexpected status code received: " + response.statusCode(), response);
    }
  }

  public static class Async extends Base
      implements AsyncRequestOperation<
          PingWebhookRequest, com.google.genai.gaos.models.operations.async.PingWebhookResponse> {
    ...
    private final Operations.CancellationRelay cancellationRelay =
        new Operations.CancellationRelay();
    ...
    private CompletableFuture<HttpRequest> onBuildRequest(PingWebhookRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request, PingWebhookRequest.class, new TypeReference<PingWebhookRequest>() {});
    ...
    private CompletableFuture<HttpResponse<InputStream>> onError(
      ...
      return this.sdkConfiguration
          .asyncHooks()
          .afterError(createAfterErrorContext(), response, error);
    }

    private CompletableFuture<HttpResponse<InputStream>> onSuccess(
        HttpResponse<InputStream> response) {
      return this.sdkConfiguration.asyncHooks().afterSuccess(createAfterSuccessContext(), response);
    }

    @Override
    public CompletableFuture<HttpResponse<InputStream>> doRequest(PingWebhookRequest request) {
      ...
      return retries
          .retry(
              (attempt) ->
                  unchecked(() -> onBuildRequest(request))
                      .get()
    ...
    @Override
    public com.google.genai.gaos.models.operations.async.PingWebhookResponse handleResponse(
        HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      com.google.genai.gaos.models.operations.async.PingWebhookResponse.Builder resBuilder =
          com.google.genai.gaos.models.operations.async.PingWebhookResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      com.google.genai.gaos.models.operations.async.PingWebhookResponse res = resBuilder.build();
