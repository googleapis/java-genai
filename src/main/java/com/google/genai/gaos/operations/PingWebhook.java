...
public class PingWebhook {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(PingWebhookRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PingWebhookRequest.class, new TypeReference<PingWebhookRequest>() {});
        ...
        public PingWebhookResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "default")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withWebhookPingResponse(Utils.unmarshal(response, new TypeReference<WebhookPingResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PingWebhookRequest, com.google.genai.gaos.models.operations.async.PingWebhookResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PingWebhookRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PingWebhookRequest.class, new TypeReference<PingWebhookRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PingWebhookRequest request) {
        ...
        @Override
        public CompletableFuture<com.google.genai.gaos.models.operations.async.PingWebhookResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "default")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<WebhookPingResponse>() {})
                            .thenApply(res::withWebhookPingResponse);
                } else {
