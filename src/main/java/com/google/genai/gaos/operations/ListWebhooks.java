...
public class ListWebhooks {
  ...
  abstract static class Base {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass, this.baseUrl, "/{api_version}/webhooks", request, this.operationGlobals);
  ...
  public static class Sync extends Base
      implements RequestOperation<ListWebhooksRequest, ListWebhooksResponse> {
    public Sync(
        @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options, Headers _headers) {
      super(sdkConfiguration, options, _headers);
    }

    private HttpRequest onBuildRequest(ListWebhooksRequest request) throws Exception {
      HttpRequest req = buildRequest(request, ListWebhooksRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListWebhooksRequest request) {
      Retries retries =
          Retries.builder()
              .action(
                  (attempt) -> {
    ...
    @Override
    public ListWebhooksResponse handleResponse(HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      ListWebhooksResponse.Builder resBuilder =
          ListWebhooksResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      ListWebhooksResponse res = resBuilder.build();
      ...
      if (Utils.statusCodeMatches(response.statusCode(), "default")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          return res.withWebhookListResponse(
              Utils.unmarshal(response, new TypeReference<WebhookListResponse>() {}));
        } else {
  ...
  public static class Async extends Base
      implements AsyncRequestOperation<
          ListWebhooksRequest, com.google.genai.gaos.models.operations.async.ListWebhooksResponse> {
    ...
    private CompletableFuture<HttpRequest> onBuildRequest(ListWebhooksRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, ListWebhooksRequest.class);
    ...
    @Override
    public CompletableFuture<HttpResponse<InputStream>> doRequest(ListWebhooksRequest request) {
    ...
    @Override
    public com.google.genai.gaos.models.operations.async.ListWebhooksResponse handleResponse(
        HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      com.google.genai.gaos.models.operations.async.ListWebhooksResponse.Builder resBuilder =
          com.google.genai.gaos.models.operations.async.ListWebhooksResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      com.google.genai.gaos.models.operations.async.ListWebhooksResponse res = resBuilder.build();
