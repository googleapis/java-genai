...
public class ListWebhooks {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    this.sdkConfiguration, this.baseUrl, "ListWebhooks", java.util.Optional.empty(), securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/{api_version}/webhooks", request, this.operationGlobals);
    ...
    public static class Sync extends Base implements RequestOperation<ListWebhooksRequest, ListWebhooksResponse> {
        ...
        public ListWebhooksResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListWebhooksResponse.Builder resBuilder = ListWebhooksResponse.builder()
