...
public class ListWebhooks {
        ...
        public ListWebhooksResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "default")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withWebhookListResponse(Utils.unmarshal(response, new TypeReference<WebhookListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListWebhooksRequest, com.google.genai.gaos.models.operations.async.ListWebhooksResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListWebhooksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListWebhooksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListWebhooksRequest request) {
        ...
        @Override
        public CompletableFuture<com.google.genai.gaos.models.operations.async.ListWebhooksResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "default")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<WebhookListResponse>() {})
                            .thenApply(res::withWebhookListResponse);
                } else {
