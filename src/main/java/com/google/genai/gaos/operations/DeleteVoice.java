...
public class DeleteVoice {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteVoiceRequest, DeleteVoiceResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteVoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteVoiceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteVoiceRequest request) {
        ...
        @Override
        public DeleteVoiceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .contentType()
                    .orElse("application/octet-stream");
            DeleteVoiceResponse.Builder resBuilder =
                    DeleteVoiceResponse
                            .builder()
            ...
            DeleteVoiceResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "default")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteVoiceResponse(Utils.unmarshal(response, new TypeReference<com.google.genai.gaos.models.voices.DeleteVoiceResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteVoiceRequest, com.google.genai.gaos.models.operations.async.DeleteVoiceResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteVoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteVoiceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<InputStream>> doRequest(DeleteVoiceRequest request) {
        ...
        @Override
        public com.google.genai.gaos.models.operations.async.DeleteVoiceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .contentType()
                    .orElse("application/octet-stream");
            com.google.genai.gaos.models.operations.async.DeleteVoiceResponse.Builder resBuilder =
                    com.google.genai.gaos.models.operations.async.DeleteVoiceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.google.genai.gaos.models.operations.async.DeleteVoiceResponse res = resBuilder.build();
