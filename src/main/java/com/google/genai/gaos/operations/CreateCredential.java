...
public class CreateCredential {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCredentialRequest, CreateCredentialResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateCredentialRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCredentialRequest.class, new TypeReference<CreateCredentialRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCredentialRequest request) {
        ...
        @Override
        public CreateCredentialResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .contentType()
                    .orElse("application/octet-stream");
            CreateCredentialResponse.Builder resBuilder =
            ...
            CreateCredentialResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCredentialRequest, com.google.genai.gaos.models.operations.async.CreateCredentialResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateCredentialRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCredentialRequest.class, new TypeReference<CreateCredentialRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<InputStream>> doRequest(CreateCredentialRequest request) {
        ...
        @Override
        public com.google.genai.gaos.models.operations.async.CreateCredentialResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .contentType()
                    .orElse("application/octet-stream");
            com.google.genai.gaos.models.operations.async.CreateCredentialResponse.Builder resBuilder =
            ...
            com.google.genai.gaos.models.operations.async.CreateCredentialResponse res = resBuilder.build();
