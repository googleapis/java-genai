...
public class GetInteractionById {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetInteractionByIdRequest, GetInteractionByIdResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetInteractionByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInteractionByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetInteractionByIdRequest request) {
        ...
        @Override
        public GetInteractionByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetInteractionByIdResponse.Builder resBuilder =
            ...
            GetInteractionByIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetInteractionByIdRequest, com.google.genai.gaos.models.operations.async.GetInteractionByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetInteractionByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInteractionByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetInteractionByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.google.genai.gaos.models.operations.async.GetInteractionByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.google.genai.gaos.models.operations.async.GetInteractionByIdResponse.Builder resBuilder =
            ...
            com.google.genai.gaos.models.operations.async.GetInteractionByIdResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "4XX")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return GetInteractionByIdClientError.fromAsync(response)
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "5XX")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return GetInteractionByIdServerError.fromAsync(response)
                            .thenCompose(com.google.genai.gaos.utils.Utils::failedFuture);
                } else {
                    return Utils.createAsyncApiError(response, "Unexpected content-type received: " + contentType);
                }
