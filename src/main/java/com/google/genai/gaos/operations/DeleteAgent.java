...
public class DeleteAgent {
  ...
  abstract static class Base {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass, this.baseUrl, "/{api_version}/agents/{id}", request, this.operationGlobals);
  ...
  public static class Sync extends Base
      implements RequestOperation<DeleteAgentRequest, DeleteAgentResponse> {
    public Sync(
        @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options, Headers _headers) {
      super(sdkConfiguration, options, _headers);
    }

    private HttpRequest onBuildRequest(DeleteAgentRequest request) throws Exception {
      HttpRequest req = buildRequest(request, DeleteAgentRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(DeleteAgentRequest request) {
      Retries retries =
          Retries.builder()
              .action(
                  (attempt) -> {
    ...
    @Override
    public DeleteAgentResponse handleResponse(HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      DeleteAgentResponse.Builder resBuilder =
          DeleteAgentResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      DeleteAgentResponse res = resBuilder.build();
      ...
      if (Utils.statusCodeMatches(response.statusCode(), "default")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          return res.withEmpty(Utils.unmarshal(response, new TypeReference<Empty>() {}));
        } else {
  ...
  public static class Async extends Base
      implements AsyncRequestOperation<
          DeleteAgentRequest, com.google.genai.gaos.models.operations.async.DeleteAgentResponse> {
    ...
    private CompletableFuture<HttpRequest> onBuildRequest(DeleteAgentRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, DeleteAgentRequest.class);
    ...
    @Override
    public CompletableFuture<HttpResponse<InputStream>> doRequest(DeleteAgentRequest request) {
    ...
    @Override
    public com.google.genai.gaos.models.operations.async.DeleteAgentResponse handleResponse(
        HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      com.google.genai.gaos.models.operations.async.DeleteAgentResponse.Builder resBuilder =
          com.google.genai.gaos.models.operations.async.DeleteAgentResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      com.google.genai.gaos.models.operations.async.DeleteAgentResponse res = resBuilder.build();
