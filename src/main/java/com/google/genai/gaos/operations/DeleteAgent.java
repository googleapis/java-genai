...
public class DeleteAgent {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteAgentRequest, com.google.genai.gaos.models.operations.async.DeleteAgentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteAgentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteAgentRequest request) {
        ...
        @Override
        public CompletableFuture<com.google.genai.gaos.models.operations.async.DeleteAgentResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "default")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Empty>() {})
                            .thenApply(res::withEmpty);
                } else {
