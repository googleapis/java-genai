...
public class DeleteAgent {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    this.sdkConfiguration, this.baseUrl, "DeleteAgent", java.util.Optional.empty(), securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/{api_version}/agents/{id}", request, this.operationGlobals);
    ...
    public static class Sync extends Base implements RequestOperation<DeleteAgentRequest, DeleteAgentResponse> {
        ...
        public DeleteAgentResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            DeleteAgentResponse.Builder resBuilder = DeleteAgentResponse.builder()
