...
public class ListAgents {
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListAgentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAgentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAgentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.google.genai.gaos.models.operations.async.ListAgentsResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "default")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AgentListResponse>() {})
                            .thenApply(res::withAgentListResponse);
                } else {
