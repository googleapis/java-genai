...
public class GetEnvironment {
  ...
  public static class Sync extends Base
      implements RequestOperation<GetEnvironmentRequest, GetEnvironmentResponse> {
    public Sync(
        @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options, Headers _headers) {
      super(sdkConfiguration, options, _headers);
    }

    private HttpRequest onBuildRequest(GetEnvironmentRequest request) throws Exception {
      HttpRequest req = buildRequest(request, GetEnvironmentRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetEnvironmentRequest request) {
      Retries retries =
          Retries.builder()
              .action(
                  (attempt) -> {
    ...
    @Override
    public GetEnvironmentResponse handleResponse(HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      GetEnvironmentResponse.Builder resBuilder =
          GetEnvironmentResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      GetEnvironmentResponse res = resBuilder.build();
  ...
  public static class Async extends Base
    ...
    private CompletableFuture<HttpRequest> onBuildRequest(GetEnvironmentRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, GetEnvironmentRequest.class);
    ...
    @Override
    public CompletableFuture<HttpResponse<InputStream>> doRequest(GetEnvironmentRequest request) {
    ...
    @Override
    public com.google.genai.gaos.models.operations.async.GetEnvironmentResponse handleResponse(
        HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      com.google.genai.gaos.models.operations.async.GetEnvironmentResponse.Builder resBuilder =
          com.google.genai.gaos.models.operations.async.GetEnvironmentResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      com.google.genai.gaos.models.operations.async.GetEnvironmentResponse res = resBuilder.build();
