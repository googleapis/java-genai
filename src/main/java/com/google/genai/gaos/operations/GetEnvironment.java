...
public class GetEnvironment {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetEnvironmentRequest, com.google.genai.gaos.models.operations.async.GetEnvironmentResponse> {
        ...
        @Override
        public com.google.genai.gaos.models.operations.async.GetEnvironmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .contentType()
                    .orElse("application/octet-stream");
