...
public class DeleteEnvironment {
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteEnvironmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteEnvironmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<InputStream>> doRequest(DeleteEnvironmentRequest request) {
