...
public class DeleteEnvironment {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(DeleteEnvironmentRequest request) throws Exception {
      HttpRequest req = buildRequest(request, DeleteEnvironmentRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(DeleteEnvironmentRequest request) {
      Retries retries =
          Retries.builder()
              .action(
                  (attempt) -> {
  ...
  public static class Async extends Base
    ...
    private CompletableFuture<HttpRequest> onBuildRequest(DeleteEnvironmentRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, DeleteEnvironmentRequest.class);
    ...
    public com.google.genai.gaos.models.operations.async.DeleteEnvironmentResponse handleResponse(
      ...
      com.google.genai.gaos.models.operations.async.DeleteEnvironmentResponse res =
          resBuilder.build();
