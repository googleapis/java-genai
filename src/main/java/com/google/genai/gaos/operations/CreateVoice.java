...
import com.google.genai.gaos.models.operations.CreateVoiceRequest;
import com.google.genai.gaos.models.operations.CreateVoiceResponse;
import com.google.genai.gaos.models.voices.VoiceOutput;
...
public class CreateVoice {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateVoiceRequest, CreateVoiceResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateVoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateVoiceRequest.class, new TypeReference<CreateVoiceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateVoiceRequest request) {
        ...
        @Override
        public CreateVoiceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .contentType()
                    .orElse("application/octet-stream");
            CreateVoiceResponse.Builder resBuilder =
                    CreateVoiceResponse
                            .builder()
            ...
            CreateVoiceResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "default")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withVoice(Utils.unmarshal(response, new TypeReference<VoiceOutput>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateVoiceRequest, com.google.genai.gaos.models.operations.async.CreateVoiceResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateVoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateVoiceRequest.class, new TypeReference<CreateVoiceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<InputStream>> doRequest(CreateVoiceRequest request) {
        ...
        @Override
        public com.google.genai.gaos.models.operations.async.CreateVoiceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .contentType()
                    .orElse("application/octet-stream");
            com.google.genai.gaos.models.operations.async.CreateVoiceResponse.Builder resBuilder =
                    com.google.genai.gaos.models.operations.async.CreateVoiceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.google.genai.gaos.models.operations.async.CreateVoiceResponse res = resBuilder.build();
