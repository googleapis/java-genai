...
public class CreateEnvironment {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass, this.baseUrl, "/{api_version}/environments", request, this.operationGlobals);
  ...
  public static class Sync extends Base
      implements RequestOperation<CreateEnvironmentRequest, CreateEnvironmentResponse> {
    public Sync(
        @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options, Headers _headers) {
      super(sdkConfiguration, options, _headers);
    }

    private HttpRequest onBuildRequest(CreateEnvironmentRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              CreateEnvironmentRequest.class,
              new TypeReference<CreateEnvironmentRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(CreateEnvironmentRequest request) {
      Retries retries =
          Retries.builder()
              .action(
                  (attempt) -> {
    ...
    @Override
    public CreateEnvironmentResponse handleResponse(HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      CreateEnvironmentResponse.Builder resBuilder =
          CreateEnvironmentResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CreateEnvironmentResponse res = resBuilder.build();
      ...
      if (Utils.statusCodeMatches(response.statusCode(), "default")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          return res.withEnvironment(
              Utils.unmarshal(response, new TypeReference<Environment>() {}));
        } else {
  ...
  public static class Async extends Base
    ...
    private CompletableFuture<HttpRequest> onBuildRequest(CreateEnvironmentRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
    ...
    @Override
    public CompletableFuture<HttpResponse<InputStream>> doRequest(
    ...
    @Override
    public com.google.genai.gaos.models.operations.async.CreateEnvironmentResponse handleResponse(
        HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      com.google.genai.gaos.models.operations.async.CreateEnvironmentResponse.Builder resBuilder =
          com.google.genai.gaos.models.operations.async.CreateEnvironmentResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      com.google.genai.gaos.models.operations.async.CreateEnvironmentResponse res =
          resBuilder.build();
