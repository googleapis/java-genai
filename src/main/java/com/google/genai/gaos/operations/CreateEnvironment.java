...
public class CreateEnvironment {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateEnvironmentRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, CreateEnvironmentRequest.class, new TypeReference<CreateEnvironmentRequest>() {});
        ...
        public CreateEnvironmentResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            CreateEnvironmentResponse.Builder resBuilder = CreateEnvironmentResponse.builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "default")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEnvironment(Utils.unmarshal(response, new TypeReference<Environment>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    CreateEnvironmentRequest, com.google.genai.gaos.models.operations.async.CreateEnvironmentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateEnvironmentRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, CreateEnvironmentRequest.class, new TypeReference<CreateEnvironmentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<InputStream>> doRequest(CreateEnvironmentRequest request) {
        ...
        public com.google.genai.gaos.models.operations.async.CreateEnvironmentResponse handleResponse(
            ...
            com.google.genai.gaos.models.operations.async.CreateEnvironmentResponse res = resBuilder.build();
