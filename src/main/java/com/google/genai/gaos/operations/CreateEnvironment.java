...
public class CreateEnvironment {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateEnvironmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateEnvironmentRequest.class, new TypeReference<CreateEnvironmentRequest>() {});
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateEnvironmentRequest, com.google.genai.gaos.models.operations.async.CreateEnvironmentResponse> {
        ...
        @Override
        public com.google.genai.gaos.models.operations.async.CreateEnvironmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .contentType()
                    .orElse("application/octet-stream");
