...
public class DeleteInteraction {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(DeleteInteractionRequest request) throws Exception {
      HttpRequest req = buildRequest(request, DeleteInteractionRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(DeleteInteractionRequest request) {
      Retries retries =
          Retries.builder()
              .action(
                  (attempt) -> {
    ...
    public DeleteInteractionResponse handleResponse(HttpResponse<InputStream> response) {
      ...
      DeleteInteractionResponse.Builder resBuilder =
          DeleteInteractionResponse.builder()
  ...
  public static class Async extends Base
    ...
    private CompletableFuture<HttpRequest> onBuildRequest(DeleteInteractionRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, DeleteInteractionRequest.class);
    ...
    public com.google.genai.gaos.models.operations.async.DeleteInteractionResponse handleResponse(
      ...
      com.google.genai.gaos.models.operations.async.DeleteInteractionResponse res =
          resBuilder.build();
