...
public class DeleteInteraction {
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteInteractionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteInteractionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteInteractionRequest request) {
        ...
        @Override
        public CompletableFuture<com.google.genai.gaos.models.operations.async.DeleteInteractionResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "4XX")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return DeleteInteractionClientError.fromAsync(response)
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "5XX")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return DeleteInteractionServerError.fromAsync(response)
                            .thenCompose(com.google.genai.gaos.utils.Utils::failedFuture);
                } else {
                    return Utils.createAsyncApiError(response, "Unexpected content-type received: " + contentType);
                }
