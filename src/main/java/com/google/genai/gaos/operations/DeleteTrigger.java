...
public class DeleteTrigger {
  ...
  public static class Async extends Base
    ...
    private CompletableFuture<HttpRequest> onBuildRequest(DeleteTriggerRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, DeleteTriggerRequest.class);
    ...
    @Override
    public CompletableFuture<HttpResponse<InputStream>> doRequest(DeleteTriggerRequest request) {
    ...
    @Override
    public com.google.genai.gaos.models.operations.async.DeleteTriggerResponse handleResponse(
        HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      com.google.genai.gaos.models.operations.async.DeleteTriggerResponse.Builder resBuilder =
          com.google.genai.gaos.models.operations.async.DeleteTriggerResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      com.google.genai.gaos.models.operations.async.DeleteTriggerResponse res = resBuilder.build();
