...
public class DeleteTrigger {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    this.sdkConfiguration, this.baseUrl, "DeleteTrigger", java.util.Optional.empty(), securitySource());
        }
    ...
    public static class Sync extends Base implements RequestOperation<DeleteTriggerRequest, DeleteTriggerResponse> {
        ...
        public DeleteTriggerResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            DeleteTriggerResponse.Builder resBuilder = DeleteTriggerResponse.builder()
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteTriggerRequest, com.google.genai.gaos.models.operations.async.DeleteTriggerResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteTriggerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteTriggerRequest.class);
