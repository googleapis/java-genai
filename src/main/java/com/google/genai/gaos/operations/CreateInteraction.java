...
public class CreateInteraction {
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateInteractionRequest request) {
        ...
        @Override
        public CompletableFuture<com.google.genai.gaos.models.operations.async.CreateInteractionResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "4XX")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return CreateInteractionClientError.fromAsync(response)
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "5XX")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return CreateInteractionServerError.fromAsync(response)
                            .thenCompose(com.google.genai.gaos.utils.Utils::failedFuture);
                } else {
                    return Utils.createAsyncApiError(response, "Unexpected content-type received: " + contentType);
                }
