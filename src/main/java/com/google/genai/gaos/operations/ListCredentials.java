...
public class ListCredentials {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCredentialsRequest, ListCredentialsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListCredentialsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCredentialsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCredentialsRequest request) {
        ...
        @Override
        public ListCredentialsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .contentType()
                    .orElse("application/octet-stream");
            ListCredentialsResponse.Builder resBuilder =
            ...
            ListCredentialsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCredentialListResponse(Utils.unmarshal(response, new TypeReference<CredentialListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCredentialsRequest, com.google.genai.gaos.models.operations.async.ListCredentialsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListCredentialsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCredentialsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<InputStream>> doRequest(ListCredentialsRequest request) {
        ...
        @Override
        public com.google.genai.gaos.models.operations.async.ListCredentialsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .contentType()
                    .orElse("application/octet-stream");
            com.google.genai.gaos.models.operations.async.ListCredentialsResponse.Builder resBuilder =
            ...
            com.google.genai.gaos.models.operations.async.ListCredentialsResponse res = resBuilder.build();
