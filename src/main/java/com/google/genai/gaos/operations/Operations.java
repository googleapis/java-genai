...
public class Operations {
  ...
  /**
   * Relays cancellation of the future returned to the SDK user to the in-flight HTTP call,
  ...
  private static final ExecutorService STREAM_COMPLETION_EXECUTOR =
      Executors.newCachedThreadPool(
          runnable -> {
            Thread thread =
                new Thread(
                    runnable,
                    "speakeasy-async-stream-completion-"
  ...
  /**
   * Runs blocking response-body reading and parsing away from the thread that completed the
   * transport future.
   */
