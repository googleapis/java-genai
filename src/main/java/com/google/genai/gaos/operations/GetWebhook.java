...
public class GetWebhook {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetWebhookRequest, com.google.genai.gaos.models.operations.async.GetWebhookResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetWebhookRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWebhookRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetWebhookRequest request) {
        ...
        @Override
        public CompletableFuture<com.google.genai.gaos.models.operations.async.GetWebhookResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "default")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Webhook>() {})
                            .thenApply(res::withWebhook);
                } else {
