...
public class GetWebhook {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    this.sdkConfiguration, this.baseUrl, "GetWebhook", java.util.Optional.empty(), securitySource());
        }
    ...
    public static class Sync extends Base implements RequestOperation<GetWebhookRequest, GetWebhookResponse> {
        ...
        public GetWebhookResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetWebhookResponse.Builder resBuilder = GetWebhookResponse.builder()
