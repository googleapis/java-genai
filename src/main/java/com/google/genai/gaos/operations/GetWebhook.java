...
public class GetWebhook {
  ...
  abstract static class Base {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass, this.baseUrl, "/{api_version}/webhooks/{id}", request, this.operationGlobals);
  ...
  public static class Sync extends Base
      implements RequestOperation<GetWebhookRequest, GetWebhookResponse> {
    public Sync(
        @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options, Headers _headers) {
      super(sdkConfiguration, options, _headers);
    }

    private HttpRequest onBuildRequest(GetWebhookRequest request) throws Exception {
      HttpRequest req = buildRequest(request, GetWebhookRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetWebhookRequest request) {
      Retries retries =
          Retries.builder()
              .action(
                  (attempt) -> {
    ...
    @Override
    public GetWebhookResponse handleResponse(HttpResponse<InputStream> response) {
  ...
  public static class Async extends Base
      implements AsyncRequestOperation<
          GetWebhookRequest, com.google.genai.gaos.models.operations.async.GetWebhookResponse> {
    ...
    private CompletableFuture<HttpRequest> onBuildRequest(GetWebhookRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, GetWebhookRequest.class);
    ...
    @Override
    public CompletableFuture<HttpResponse<InputStream>> doRequest(GetWebhookRequest request) {
    ...
    @Override
    public com.google.genai.gaos.models.operations.async.GetWebhookResponse handleResponse(
        HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      com.google.genai.gaos.models.operations.async.GetWebhookResponse.Builder resBuilder =
          com.google.genai.gaos.models.operations.async.GetWebhookResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      com.google.genai.gaos.models.operations.async.GetWebhookResponse res = resBuilder.build();
