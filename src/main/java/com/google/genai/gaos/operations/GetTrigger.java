...
public class GetTrigger {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    this.sdkConfiguration, this.baseUrl, "GetTrigger", java.util.Optional.empty(), securitySource());
        }
    ...
    public static class Sync extends Base implements RequestOperation<GetTriggerRequest, GetTriggerResponse> {
        ...
        public GetTriggerResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetTriggerResponse.Builder resBuilder = GetTriggerResponse.builder()
