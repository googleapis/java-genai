...
public class GetTrigger {
  ...
  abstract static class Base {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass, this.baseUrl, "/{api_version}/triggers/{id}", request, this.operationGlobals);
  ...
  public static class Sync extends Base
      implements RequestOperation<GetTriggerRequest, GetTriggerResponse> {
    public Sync(
        @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options, Headers _headers) {
      super(sdkConfiguration, options, _headers);
    }

    private HttpRequest onBuildRequest(GetTriggerRequest request) throws Exception {
      HttpRequest req = buildRequest(request, GetTriggerRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetTriggerRequest request) {
      Retries retries =
          Retries.builder()
              .action(
                  (attempt) -> {
    ...
    @Override
    public GetTriggerResponse handleResponse(HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      GetTriggerResponse.Builder resBuilder =
          GetTriggerResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      GetTriggerResponse res = resBuilder.build();
  ...
  public static class Async extends Base
      implements AsyncRequestOperation<
          GetTriggerRequest, com.google.genai.gaos.models.operations.async.GetTriggerResponse> {
    ...
    private CompletableFuture<HttpRequest> onBuildRequest(GetTriggerRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, GetTriggerRequest.class);
    ...
    @Override
    public CompletableFuture<HttpResponse<InputStream>> doRequest(GetTriggerRequest request) {
    ...
    @Override
    public com.google.genai.gaos.models.operations.async.GetTriggerResponse handleResponse(
        HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      com.google.genai.gaos.models.operations.async.GetTriggerResponse.Builder resBuilder =
          com.google.genai.gaos.models.operations.async.GetTriggerResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      com.google.genai.gaos.models.operations.async.GetTriggerResponse res = resBuilder.build();
