...
public class GetTrigger {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTriggerRequest, com.google.genai.gaos.models.operations.async.GetTriggerResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetTriggerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTriggerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTriggerRequest request) {
        ...
        @Override
        public CompletableFuture<com.google.genai.gaos.models.operations.async.GetTriggerResponse> handleResponse(
            ...
            com.google.genai.gaos.models.operations.async.GetTriggerResponse.Builder resBuilder =
                    com.google.genai.gaos.models.operations.async.GetTriggerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Trigger>() {})
                            .thenApply(res::withTrigger);
                } else {
