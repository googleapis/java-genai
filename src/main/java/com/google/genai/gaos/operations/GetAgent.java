...
public class GetAgent {
  ...
  public static class Async extends Base
      implements AsyncRequestOperation<
          GetAgentRequest, com.google.genai.gaos.models.operations.async.GetAgentResponse> {
    ...
    private CompletableFuture<HttpRequest> onBuildRequest(GetAgentRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, GetAgentRequest.class);
    ...
    @Override
    public com.google.genai.gaos.models.operations.async.GetAgentResponse handleResponse(
        HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
