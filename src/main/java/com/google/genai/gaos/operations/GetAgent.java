...
public class GetAgent {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    this.sdkConfiguration, this.baseUrl, "GetAgent", java.util.Optional.empty(), securitySource());
        }
    ...
    public static class Sync extends Base implements RequestOperation<GetAgentRequest, GetAgentResponse> {
        ...
        public GetAgentResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetAgentResponse.Builder resBuilder = GetAgentResponse.builder()
