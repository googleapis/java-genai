...
public class ListTriggers {
  ...
  abstract static class Base {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass, this.baseUrl, "/{api_version}/triggers", request, this.operationGlobals);
  ...
  public static class Sync extends Base
      implements RequestOperation<ListTriggersRequest, ListTriggersResponse> {
    public Sync(
        @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options, Headers _headers) {
      super(sdkConfiguration, options, _headers);
    }

    private HttpRequest onBuildRequest(ListTriggersRequest request) throws Exception {
      HttpRequest req = buildRequest(request, ListTriggersRequest.class);
    ...
    public ListTriggersResponse handleResponse(HttpResponse<InputStream> response) {
      ...
      ListTriggersResponse.Builder resBuilder =
          ListTriggersResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      ListTriggersResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          return res.withListTriggersResponse(
              Utils.unmarshal(
                  response,
                  new TypeReference<
                      com.google.genai.gaos.models.triggers.ListTriggersResponse>() {}));
        } else {
  ...
  public static class Async extends Base
      implements AsyncRequestOperation<
          ListTriggersRequest, com.google.genai.gaos.models.operations.async.ListTriggersResponse> {
    ...
    private CompletableFuture<HttpRequest> onBuildRequest(ListTriggersRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, ListTriggersRequest.class);
    ...
    @Override
    public CompletableFuture<HttpResponse<InputStream>> doRequest(ListTriggersRequest request) {
    ...
    @Override
    public com.google.genai.gaos.models.operations.async.ListTriggersResponse handleResponse(
        HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      com.google.genai.gaos.models.operations.async.ListTriggersResponse.Builder resBuilder =
          com.google.genai.gaos.models.operations.async.ListTriggersResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      com.google.genai.gaos.models.operations.async.ListTriggersResponse res = resBuilder.build();
