...
public class ListTriggers {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    this.sdkConfiguration, this.baseUrl, "ListTriggers", java.util.Optional.empty(), securitySource());
        }
    ...
    public static class Sync extends Base implements RequestOperation<ListTriggersRequest, ListTriggersResponse> {
        ...
        public ListTriggersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListTriggersResponse.Builder resBuilder = ListTriggersResponse.builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListTriggersResponse(Utils.unmarshal(
                            response, new TypeReference<com.google.genai.gaos.models.triggers.ListTriggersResponse>() {}));
                } else {
