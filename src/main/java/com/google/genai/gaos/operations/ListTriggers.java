...
public class ListTriggers {
        ...
        public ListTriggersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListTriggersResponse(Utils.unmarshal(response, new TypeReference<com.google.genai.gaos.models.triggers.ListTriggersResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTriggersRequest, com.google.genai.gaos.models.operations.async.ListTriggersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListTriggersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTriggersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTriggersRequest request) {
        ...
        @Override
        public CompletableFuture<com.google.genai.gaos.models.operations.async.ListTriggersResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.google.genai.gaos.models.triggers.ListTriggersResponse>() {})
                            .thenApply(res::withListTriggersResponse);
                } else {
