...
public class RotateSigningSecret {
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RotateSigningSecretRequest request) {
        ...
        @Override
        public CompletableFuture<com.google.genai.gaos.models.operations.async.RotateSigningSecretResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "default")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<WebhookRotateSigningSecretResponse>() {})
                            .thenApply(res::withWebhookRotateSigningSecretResponse);
                } else {
