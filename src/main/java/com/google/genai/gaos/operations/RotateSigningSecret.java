...
public class RotateSigningSecret {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(RotateSigningSecretRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              RotateSigningSecretRequest.class,
              new TypeReference<RotateSigningSecretRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(RotateSigningSecretRequest request) {
      Retries retries =
          Retries.builder()
              .action(
                  (attempt) -> {
    ...
    public RotateSigningSecretResponse handleResponse(HttpResponse<InputStream> response) {
      ...
      RotateSigningSecretResponse.Builder resBuilder =
          RotateSigningSecretResponse.builder()
      ...
      if (Utils.statusCodeMatches(response.statusCode(), "default")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          return res.withWebhookRotateSigningSecretResponse(
              Utils.unmarshal(
                  response, new TypeReference<WebhookRotateSigningSecretResponse>() {}));
        } else {
  ...
  public static class Async extends Base
    ...
    private CompletableFuture<HttpRequest> onBuildRequest(RotateSigningSecretRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
    ...
    public com.google.genai.gaos.models.operations.async.RotateSigningSecretResponse handleResponse(
      ...
      com.google.genai.gaos.models.operations.async.RotateSigningSecretResponse res =
          resBuilder.build();
