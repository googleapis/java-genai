...
public class CancelInteractionById {
  ...
  public static class Sync extends Base
    ...
    public CancelInteractionByIdResponse handleResponse(HttpResponse<InputStream> response) {
      ...
      CancelInteractionByIdResponse.Builder resBuilder =
          CancelInteractionByIdResponse.builder()
      ...
      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          return res.withInteraction(
              Utils.unmarshal(response, new TypeReference<Interaction>() {}));
        } else {
  ...
  public static class Async extends Base
    ...
    private CompletableFuture<HttpRequest> onBuildRequest(CancelInteractionByIdRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, CancelInteractionByIdRequest.class);
    ...
    @Override
    public com.google.genai.gaos.models.operations.async.CancelInteractionByIdResponse
        handleResponse(HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      com.google.genai.gaos.models.operations.async.CancelInteractionByIdResponse.Builder
          resBuilder =
              com.google.genai.gaos.models.operations.async.CancelInteractionByIdResponse.builder()
                  .contentType(contentType)
                  .statusCode(response.statusCode())
      ...
      com.google.genai.gaos.models.operations.async.CancelInteractionByIdResponse res =
          resBuilder.build();
