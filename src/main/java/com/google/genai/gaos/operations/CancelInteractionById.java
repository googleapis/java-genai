...
public class CancelInteractionById {
    ...
    public static class Sync extends Base
            implements RequestOperation<CancelInteractionByIdRequest, CancelInteractionByIdResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CancelInteractionByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelInteractionByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelInteractionByIdRequest request) {
        ...
        @Override
        public CancelInteractionByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CancelInteractionByIdResponse.Builder resBuilder =
            ...
            CancelInteractionByIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CancelInteractionByIdRequest, com.google.genai.gaos.models.operations.async.CancelInteractionByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CancelInteractionByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelInteractionByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CancelInteractionByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.google.genai.gaos.models.operations.async.CancelInteractionByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.google.genai.gaos.models.operations.async.CancelInteractionByIdResponse.Builder resBuilder =
            ...
            com.google.genai.gaos.models.operations.async.CancelInteractionByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Interaction>() {})
                            .thenApply(res::withInteraction);
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "4XX")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return CancelInteractionByIdClientError.fromAsync(response)
                            .thenCompose(com.google.genai.gaos.utils.Utils::failedFuture);
                } else {
                    return Utils.createAsyncApiError(response, "Unexpected content-type received: " + contentType);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "5XX")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return CancelInteractionByIdServerError.fromAsync(response)
                            .thenCompose(com.google.genai.gaos.utils.Utils::failedFuture);
                } else {
                    return Utils.createAsyncApiError(response, "Unexpected content-type received: " + contentType);
                }
