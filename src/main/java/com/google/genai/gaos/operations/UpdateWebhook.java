...
public class UpdateWebhook {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(UpdateWebhookRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request, UpdateWebhookRequest.class, new TypeReference<UpdateWebhookRequest>() {});
  ...
  public static class Async extends Base
    ...
    private CompletableFuture<HttpRequest> onBuildRequest(UpdateWebhookRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request, UpdateWebhookRequest.class, new TypeReference<UpdateWebhookRequest>() {});
    ...
    @Override
    public CompletableFuture<HttpResponse<InputStream>> doRequest(UpdateWebhookRequest request) {
    ...
    @Override
    public com.google.genai.gaos.models.operations.async.UpdateWebhookResponse handleResponse(
        HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      com.google.genai.gaos.models.operations.async.UpdateWebhookResponse.Builder resBuilder =
          com.google.genai.gaos.models.operations.async.UpdateWebhookResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      com.google.genai.gaos.models.operations.async.UpdateWebhookResponse res = resBuilder.build();
