...
public class UpdateWebhook {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    this.sdkConfiguration, this.baseUrl, "UpdateWebhook", java.util.Optional.empty(), securitySource());
        }
    ...
    public static class Sync extends Base implements RequestOperation<UpdateWebhookRequest, UpdateWebhookResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateWebhookRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, UpdateWebhookRequest.class, new TypeReference<UpdateWebhookRequest>() {});
        ...
        public UpdateWebhookResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            UpdateWebhookResponse.Builder resBuilder = UpdateWebhookResponse.builder()
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateWebhookRequest, com.google.genai.gaos.models.operations.async.UpdateWebhookResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateWebhookRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, UpdateWebhookRequest.class, new TypeReference<UpdateWebhookRequest>() {});
