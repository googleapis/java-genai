...
public class CreateAgent {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass, this.baseUrl, "/{api_version}/agents", request, this.operationGlobals);
  ...
  public static class Sync extends Base
      implements RequestOperation<CreateAgentRequest, CreateAgentResponse> {
    public Sync(
        @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options, Headers _headers) {
      super(sdkConfiguration, options, _headers);
    }

    private HttpRequest onBuildRequest(CreateAgentRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request, CreateAgentRequest.class, new TypeReference<CreateAgentRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(CreateAgentRequest request) {
      Retries retries =
          Retries.builder()
              .action(
                  (attempt) -> {
    ...
    @Override
    public CreateAgentResponse handleResponse(HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      CreateAgentResponse.Builder resBuilder =
          CreateAgentResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CreateAgentResponse res = resBuilder.build();
  ...
  public static class Async extends Base
      implements AsyncRequestOperation<
          CreateAgentRequest, com.google.genai.gaos.models.operations.async.CreateAgentResponse> {
    ...
    private CompletableFuture<HttpRequest> onBuildRequest(CreateAgentRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request, CreateAgentRequest.class, new TypeReference<CreateAgentRequest>() {});
    ...
    @Override
    public CompletableFuture<HttpResponse<InputStream>> doRequest(CreateAgentRequest request) {
    ...
    @Override
    public com.google.genai.gaos.models.operations.async.CreateAgentResponse handleResponse(
        HttpResponse<InputStream> response) {
      String contentType = response.contentType().orElse("application/octet-stream");
      com.google.genai.gaos.models.operations.async.CreateAgentResponse.Builder resBuilder =
          com.google.genai.gaos.models.operations.async.CreateAgentResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      com.google.genai.gaos.models.operations.async.CreateAgentResponse res = resBuilder.build();
