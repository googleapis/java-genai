...
public class CreateAgent {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    this.sdkConfiguration, this.baseUrl, "CreateAgent", java.util.Optional.empty(), securitySource());
        }
    ...
    public static class Sync extends Base implements RequestOperation<CreateAgentRequest, CreateAgentResponse> {
        ...
        private HttpRequest onBuildRequest(CreateAgentRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, CreateAgentRequest.class, new TypeReference<CreateAgentRequest>() {});
        ...
        public CreateAgentResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            CreateAgentResponse.Builder resBuilder = CreateAgentResponse.builder()
