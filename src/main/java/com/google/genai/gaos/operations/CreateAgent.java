...
public class CreateAgent {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAgentRequest.class, new TypeReference<CreateAgentRequest>() {});
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAgentRequest, com.google.genai.gaos.models.operations.async.CreateAgentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAgentRequest.class, new TypeReference<CreateAgentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAgentRequest request) {
        ...
        @Override
        public CompletableFuture<com.google.genai.gaos.models.operations.async.CreateAgentResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "default")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Agent>() {})
                            .thenApply(res::withAgent);
                } else {
