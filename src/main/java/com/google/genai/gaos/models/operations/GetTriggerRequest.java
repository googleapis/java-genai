...
public class GetTriggerRequest {
     ...
     * Which version of the API to use.
     */
    public GetTriggerRequest withApiVersion(String apiVersion) {
        Utils.checkNotNull(apiVersion, "apiVersion");
     ...
     * Which version of the API to use.
     */
    public GetTriggerRequest withApiVersion(Optional<String> apiVersion) {
        Utils.checkNotNull(apiVersion, "apiVersion");
        this.apiVersion = apiVersion;
        return this;
    }
     ...
     * Resource name of the trigger.
     */
    public GetTriggerRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
