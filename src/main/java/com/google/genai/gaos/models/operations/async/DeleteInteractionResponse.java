...
public class DeleteInteractionResponse implements AsyncResponse {
     ...
     * HTTP response content type for this operation
     */
    public DeleteInteractionResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteInteractionResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
