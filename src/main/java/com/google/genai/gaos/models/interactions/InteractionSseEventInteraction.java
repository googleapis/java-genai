 ...
 *
 * <p>Partial interaction resource emitted by interaction lifecycle SSE events. Streaming lifecycle
...
public class InteractionSseEventInteraction {
  ...
  public InteractionSseEventInteraction(
      @Nonnull String id, @Nonnull InteractionSseEventInteractionStatus status) {
    this(id, null, null, null, status, null, null, null, null, null);
  }
  ...
  /** Required. Output only. The status of the interaction. */
  public InteractionSseEventInteraction withStatus(
  ...
  public int hashCode() {
    return Utils.enhancedHash(
        id, object, model, agent, status, created, updated, serviceTier, usage, steps);
  }
