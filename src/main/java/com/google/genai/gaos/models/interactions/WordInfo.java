 ...
 * WordInfo
 *
 * <p>Word-level ASR annotation for transcription output. Carries the word text, optional timing,
...
public class WordInfo implements Annotation {
  ...
  public static final class Builder {
    ...
    /**
     * Optional. Speaker label for this word (e.g. "spk_1", "spk_2"). Present when diarization_mode
     * is set in TranscriptionConfig.
     */
