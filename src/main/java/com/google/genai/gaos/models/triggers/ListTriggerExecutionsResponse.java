...
public class ListTriggerExecutionsResponse {
  /**
   * A page token, received from a previous `ListTriggerExecutions` call. Provide this to retrieve
   * the subsequent page.
   */
  ...
  public ListTriggerExecutionsResponse(
      ...
      @JsonProperty("trigger_executions") @Nullable List<TriggerExecution> triggerExecutions) {
  ...
  public Optional<List<TriggerExecution>> triggerExecutions() {
    return Optional.ofNullable(this.triggerExecutions);
  }
   ...
   * the subsequent page.
   */
  public ListTriggerExecutionsResponse withNextPageToken(@Nullable String nextPageToken) {
    this.nextPageToken = nextPageToken;
    return this;
  }

  /** The list of trigger executions. */
  public ListTriggerExecutionsResponse withTriggerExecutions(
      @Nullable List<TriggerExecution> triggerExecutions) {
    this.triggerExecutions = triggerExecutions;
    return this;
  }
  ...
  public static final class Builder {
    ...
    /** The list of trigger executions. */
    public Builder triggerExecutions(@Nullable List<TriggerExecution> triggerExecutions) {
      this.triggerExecutions = triggerExecutions;
      return this;
    }
