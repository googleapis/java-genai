...
public class StreamMetadata {
  ...
  @JsonCreator
  public StreamMetadata(@JsonProperty("total_usage") @Nullable Usage totalUsage) {
  ...
  public String toString() {
    return Utils.toString(StreamMetadata.class, "totalUsage", totalUsage);
  }
  ...
  public static final class Builder {
    ...
    public StreamMetadata build() {
      return new StreamMetadata(totalUsage);
    }
  }
}
