...
public class CreateWebhookRequestBuilder {
  ...
  private final CreateWebhookRequest.Builder pojoBuilder;
  private CreateWebhookRequest request;
  private final Options.Builder optionsBuilder;
  private boolean _setterCalled;

  public CreateWebhookRequestBuilder(SDKConfiguration sdkConfiguration) {
    this.sdkConfiguration = sdkConfiguration;
    this.pojoBuilder = CreateWebhookRequest.builder();
    this.optionsBuilder = Options.builder();
  }

  public CreateWebhookRequestBuilder apiVersion(@Nullable String apiVersion) {
    this.pojoBuilder.apiVersion(apiVersion);
    this._setterCalled = true;
    return this;
  }

  public CreateWebhookRequestBuilder body(@Nonnull WebhookInput body) {
  ...
  private CreateWebhookRequest _buildRequest() {
  ...
  public CreateWebhookRequestBuilder header(String name, String value) {
   ...
   */
  public CompletableFuture<CreateWebhookResponse> call() {
