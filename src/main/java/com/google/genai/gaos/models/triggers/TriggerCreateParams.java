...
public class TriggerCreateParams {
  ...
  public TriggerCreateParams(
      @Nonnull String schedule, @Nonnull String timeZone, @Nonnull Interaction interaction) {
  ...
  /** Optional. The execution timeout for the triggered interaction. */
  public TriggerCreateParams withExecutionTimeoutSeconds(
      @Nullable Integer executionTimeoutSeconds) {
    this.executionTimeoutSeconds = executionTimeoutSeconds;
    return this;
  }
