...
public class ToolChoice {
  ...
  public static ToolChoice of(ToolChoiceConfig value) {
    ...
    return new ToolChoice(
        TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<ToolChoiceConfig>() {}));
  }

  public static ToolChoice of(ToolChoiceType value) {
    Utils.checkNotNull(value, "value");
    return new ToolChoice(
        TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<ToolChoiceType>() {}));
  }
   ...
   *
   * @return an {@link Optional} containing the {@code ToolChoiceConfig} value, or empty if not of
   *     this type
   */
   ...
   * otherwise returns an empty {@link Optional}.
   *
   * @return an {@link Optional} containing the {@code ToolChoiceType} value, or empty if not of
   *     this type
   */
