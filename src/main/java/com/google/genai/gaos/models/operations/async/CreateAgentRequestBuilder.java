...
public class CreateAgentRequestBuilder {
  ...
  private final CreateAgentRequest.Builder pojoBuilder;
  ...
  public CreateAgentRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    this.pojoBuilder = CreateAgentRequest.builder();
    this.optionsBuilder = Options.builder();
  }

  public CreateAgentRequestBuilder apiVersion(@Nullable String apiVersion) {
    this.pojoBuilder.apiVersion(apiVersion);
    this._setterCalled = true;
    return this;
  }

  public CreateAgentRequestBuilder body(@Nonnull Agent body) {
