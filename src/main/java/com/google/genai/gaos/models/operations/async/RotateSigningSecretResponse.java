...
public class RotateSigningSecretResponse implements AsyncResponse {
    ...
    public Optional<WebhookRotateSigningSecretResponse> webhookRotateSigningSecretResponse() {
        return Optional.ofNullable(this.webhookRotateSigningSecretResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public RotateSigningSecretResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public RotateSigningSecretResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
