...
public class GetAgentRequestBuilder {
  ...
  private final GetAgentRequest.Builder pojoBuilder;
  private GetAgentRequest request;
  private final Options.Builder optionsBuilder;
  private boolean _setterCalled;

  public GetAgentRequestBuilder(SDKConfiguration sdkConfiguration) {
    this.sdkConfiguration = sdkConfiguration;
    this.pojoBuilder = GetAgentRequest.builder();
    this.optionsBuilder = Options.builder();
  }

  public GetAgentRequestBuilder apiVersion(@Nullable String apiVersion) {
    this.pojoBuilder.apiVersion(apiVersion);
    this._setterCalled = true;
    return this;
  }

  public GetAgentRequestBuilder id(@Nonnull String id) {
  ...
  private GetAgentRequest _buildRequest() {
  ...
  public GetAgentRequestBuilder header(String name, String value) {
