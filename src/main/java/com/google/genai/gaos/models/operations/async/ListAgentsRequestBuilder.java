...
public class ListAgentsRequestBuilder {
  ...
  private final ListAgentsRequest.Builder pojoBuilder;
  private ListAgentsRequest request;
  private final Options.Builder optionsBuilder;
  private boolean _setterCalled;

  public ListAgentsRequestBuilder(SDKConfiguration sdkConfiguration) {
    this.sdkConfiguration = sdkConfiguration;
    this.pojoBuilder = ListAgentsRequest.builder();
    this.optionsBuilder = Options.builder();
  }

  public ListAgentsRequestBuilder apiVersion(@Nullable String apiVersion) {
    this.pojoBuilder.apiVersion(apiVersion);
    this._setterCalled = true;
    return this;
  }

  public ListAgentsRequestBuilder pageSize(@Nullable Integer pageSize) {
    this.pojoBuilder.pageSize(pageSize);
    this._setterCalled = true;
    return this;
  }

  public ListAgentsRequestBuilder pageToken(@Nullable String pageToken) {
    this.pojoBuilder.pageToken(pageToken);
    this._setterCalled = true;
    return this;
  }

  public ListAgentsRequestBuilder parent(@Nullable String parent) {
    this.pojoBuilder.parent(parent);
    this._setterCalled = true;
    return this;
  }
  ...
  private ListAgentsRequest _buildRequest() {
