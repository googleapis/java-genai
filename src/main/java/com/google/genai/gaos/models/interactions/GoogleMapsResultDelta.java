...
public class GoogleMapsResultDelta implements StepDeltaData {
  ...
  /** The results of the Google Maps. */
  public GoogleMapsResultDelta withResult(@Nullable List<GoogleMapsResult> result) {
    this.result = result;
    return this;
  }

  /** A signature hash for backend validation. */
  public GoogleMapsResultDelta withSignature(@Nullable String signature) {
    this.signature = signature;
    return this;
  }
  ...
  public String toString() {
    return Utils.toString(
        GoogleMapsResultDelta.class, "result", result, "signature", signature, "type", type);
  }
  ...
  public static final class Builder {
    ...
    /** The results of the Google Maps. */
    public Builder result(@Nullable List<GoogleMapsResult> result) {
      this.result = result;
      return this;
    }
