 ...
 */
public class RetrievalResultDelta implements StepDeltaData {
  ...
  /** Whether the retrieval resulted in an error. */
  public RetrievalResultDelta withIsError(@Nullable Boolean isError) {
    this.isError = isError;
    return this;
  }

  /** A signature hash for backend validation. */
  public RetrievalResultDelta withSignature(@Nullable String signature) {
    this.signature = signature;
    return this;
  }
  ...
  public String toString() {
    return Utils.toString(
        RetrievalResultDelta.class, "isError", isError, "signature", signature, "type", type);
  }
