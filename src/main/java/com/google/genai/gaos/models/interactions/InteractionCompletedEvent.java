...
public class InteractionCompletedEvent implements InteractionSSEEvent {
  ...
  /**
   * Partial interaction resource emitted by interaction lifecycle SSE events. Streaming lifecycle
   * payloads may omit fields that are only available on full non-streaming Interaction responses.
   */
   ...
   * payloads may omit fields that are only available on full non-streaming Interaction responses.
   */
  public InteractionCompletedEvent withInteraction(
  ...
  @Override
  public int hashCode() {
    return Utils.enhancedHash(eventType, eventId, metadata, interaction);
  }
  ...
  public static final class Builder {
    ...
    public InteractionCompletedEvent build() {
      return new InteractionCompletedEvent(eventId, metadata, interaction);
    }

    private static final LazySingletonValue<String> _SINGLETON_VALUE_EventType =
        new LazySingletonValue<>(
            "event_type", "\"interaction.completed\"", new TypeReference<String>() {});
  }
}
