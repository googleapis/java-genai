...
public class DeleteTriggerResponse implements AsyncResponse {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteTriggerResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Successful operation
     */
    public DeleteTriggerResponse withEmpty(Empty empty) {
        Utils.checkNotNull(empty, "empty");
     ...
     * Successful operation
     */
    public DeleteTriggerResponse withEmpty(Optional<? extends Empty> empty) {
        Utils.checkNotNull(empty, "empty");
        this.empty = empty;
        return this;
    }
