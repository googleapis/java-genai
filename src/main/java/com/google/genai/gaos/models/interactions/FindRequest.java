 ...
 * FindRequest
 *
 * <p>Request parameters specific to FIND sessions, used for discovering vulnerabilities in a
 * codebase.
 */
public class FindRequest {
  ...
  public static final class Builder {
    ...
    /**
     * The identifier of a specific finding to verify. This is primarily used in VERIFY mode to
     * focus the agent's execution-based validation on a single vulnerability.
     */
