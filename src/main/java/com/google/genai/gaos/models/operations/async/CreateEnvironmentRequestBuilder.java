...
public class CreateEnvironmentRequestBuilder {
  ...
  private final CreateEnvironmentRequest.Builder pojoBuilder;
  ...
  public CreateEnvironmentRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    this.pojoBuilder = CreateEnvironmentRequest.builder();
    this.optionsBuilder = Options.builder();
  }

  public CreateEnvironmentRequestBuilder apiVersion(@Nullable String apiVersion) {
