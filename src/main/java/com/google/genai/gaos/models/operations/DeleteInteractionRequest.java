...
public class DeleteInteractionRequest {
     ...
     * The unique identifier of the interaction to delete.
     */
    public DeleteInteractionRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Which version of the API to use.
     */
    public DeleteInteractionRequest withApiVersion(String apiVersion) {
        Utils.checkNotNull(apiVersion, "apiVersion");
     ...
     * Which version of the API to use.
     */
    public DeleteInteractionRequest withApiVersion(Optional<String> apiVersion) {
        Utils.checkNotNull(apiVersion, "apiVersion");
        this.apiVersion = apiVersion;
        return this;
    }
