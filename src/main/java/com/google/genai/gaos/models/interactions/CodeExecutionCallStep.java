 ...
 */
public class CodeExecutionCallStep implements Step {
    /**
    ...
    public CodeExecutionCallStep(@Nonnull CodeExecutionCallArguments arguments, @Nonnull String id) {
     ...
     * The arguments to pass to the code execution.
     */
    public CodeExecutionCallStep withArguments(@Nonnull CodeExecutionCallArguments arguments) {
     ...
     * Required. A unique ID for this specific tool call.
     */
    public CodeExecutionCallStep withId(@Nonnull String id) {
     ...
     * A signature hash for backend validation.
     */
    public CodeExecutionCallStep withSignature(@Nullable String signature) {
        this.signature = signature;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(
                CodeExecutionCallStep.class, "arguments", arguments, "id", id, "signature", signature, "type", type);
    }
    ...
    public static final class Builder {
        ...
        public CodeExecutionCallStep build() {
            return new CodeExecutionCallStep(arguments, id, signature);
        }
