...
public class MCPServerToolResultDeltaResultUnion {
    ...
    public static MCPServerToolResultDeltaResultUnion of(MCPServerToolResultDeltaResult value) {
        ...
        return new MCPServerToolResultDeltaResultUnion(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>(){}));
    }
     ...
     * <ul>
     * <li>{@code com.google.genai.gaos.models.interactions.MCPServerToolResultDeltaResult}</li>
