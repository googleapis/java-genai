...
public class Trigger {
  /**
   * Output only. The number of consecutive failures that have occurred since the last successful
   * execution.
   */
  ...
  /**
   * Optional. The maximum number of consecutive failures allowed before the trigger is
   * automatically paused (status becomes ERROR).
   */
  @JsonInclude(Include.NON_ABSENT)
