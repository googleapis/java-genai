...
public class GoogleMapsCallStep implements Step {
  ...
  /** The arguments to pass to the Google Maps tool. */
  public GoogleMapsCallStep withArguments(@Nullable GoogleMapsCallArguments arguments) {
    this.arguments = arguments;
    return this;
  }

  /** Required. A unique ID for this specific tool call. */
  public GoogleMapsCallStep withId(@Nonnull String id) {
    this.id = Utils.checkNotNull(id, "id");
    return this;
  }

  /** A signature hash for backend validation. */
  public GoogleMapsCallStep withSignature(@Nullable String signature) {
    this.signature = signature;
    return this;
  }
