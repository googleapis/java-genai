...
public class GoogleMapsResultStep implements Step {
     ...
     * Required. ID to match the ID from the function call block.
     */
    public GoogleMapsResultStep withCallId(@Nonnull String callId) {
     ...
     * A signature hash for backend validation.
     */
    public GoogleMapsResultStep withSignature(@Nullable String signature) {
        this.signature = signature;
        return this;
    }
    ...
    public static final class Builder {
        ...
        public Builder result(@Nonnull List<GoogleMapsResult> result) {
            this.result = Utils.checkNotNull(result, "result");
            return this;
        }
