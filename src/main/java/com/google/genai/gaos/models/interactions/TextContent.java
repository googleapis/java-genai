...
public class TextContent implements Content, ThoughtSummaryContent, FunctionResultSubcontent {
  ...
  /** Citation information for model-generated content. */
  public TextContent withAnnotations(@Nullable List<Annotation> annotations) {
    this.annotations = annotations;
    return this;
  }

  /** Required. The text content. */
  public TextContent withText(@Nonnull String text) {
  ...
  public String toString() {
    return Utils.toString(
        TextContent.class, "annotations", annotations, "text", text, "type", type);
  }
  ...
  public static final class Builder {
    ...
    /** Citation information for model-generated content. */
    public Builder annotations(@Nullable List<Annotation> annotations) {
      this.annotations = annotations;
      return this;
    }
