...
public class URLContextCallStep {
    ...
    public URLContextCallStep(
            @JsonProperty("arguments") URLContextCallArguments arguments,
     ...
     * The arguments to pass to the URL context.
     */
    public URLContextCallStep withArguments(URLContextCallArguments arguments) {
        Utils.checkNotNull(arguments, "arguments");
        this.arguments = arguments;
        return this;
    }
     ...
     * Required. A unique ID for this specific tool call.
     */
    public URLContextCallStep withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * A signature hash for backend validation.
     */
    public URLContextCallStep withSignature(String signature) {
        Utils.checkNotNull(signature, "signature");
     ...
     * A signature hash for backend validation.
     */
    public URLContextCallStep withSignature(Optional<String> signature) {
        Utils.checkNotNull(signature, "signature");
        this.signature = signature;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * The arguments to pass to the URL context.
         */
        public Builder arguments(URLContextCallArguments arguments) {
            Utils.checkNotNull(arguments, "arguments");
            this.arguments = arguments;
            return this;
        }
