...
public class StepStop implements InteractionSSEEvent {
  ...
  public StepStop(int index) {
    this(null, index, null, null, null);
  }
  ...
  @Override
  public int hashCode() {
    return Utils.enhancedHash(eventId, eventType, index, metadata, stepUsage, usage);
  }
  ...
  public static final class Builder {
    ...
    public StepStop build() {
      return new StepStop(eventId, index, metadata, stepUsage, usage);
    }
