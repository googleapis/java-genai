...
@JsonDeserialize(using = MediaProcessing._Deserializer.class)
public class MediaProcessing {
     ...
     *
     * @return an {@link Optional} containing the {@code StaticMediaProcessing} value, or empty if not of this type
     */
    public Optional<StaticMediaProcessing> staticMediaProcessing() {
        if (value.value() instanceof StaticMediaProcessing) {
            return Optional.of((StaticMediaProcessing) value.value());
        }
