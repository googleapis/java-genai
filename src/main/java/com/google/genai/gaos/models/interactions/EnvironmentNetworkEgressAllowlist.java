 ...
 *
 * <p>Outbound networking configuration for the sandbox. Accepts an object with an 'allowlist' array
 * to restrict traffic, or the string 'disabled' to turn off all network access. Omit entirely to
...
public class EnvironmentNetworkEgressAllowlist {
  ...
  public static EnvironmentNetworkEgressAllowlist of(Allowlist value) {
    ...
    return new EnvironmentNetworkEgressAllowlist(
        TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<Allowlist>() {}));
  }

  public static EnvironmentNetworkEgressAllowlist of(Disabled value) {
    Utils.checkNotNull(value, "value");
    return new EnvironmentNetworkEgressAllowlist(
        TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<Disabled>() {}));
  }

  /**
   * Returns an {@link Optional} containing the value if it is of type {@code Allowlist}, otherwise
   * returns an empty {@link Optional}.
   *
   * @return an {@link Optional} containing the {@code Allowlist} value, or empty if not of this
   *     type
   */
  ...
  /**
   * Returns an {@link Optional} containing the value if it is of type {@code Disabled}, otherwise
   * returns an empty {@link Optional}.
   *
  ...
  public static final class _Deserializer
      extends OneOfDeserializer<EnvironmentNetworkEgressAllowlist> {

    public _Deserializer() {
      super(
          EnvironmentNetworkEgressAllowlist.class,
          false,
  ...
  public String toString() {
    return Utils.toString(EnvironmentNetworkEgressAllowlist.class, "value", value);
  }
}
