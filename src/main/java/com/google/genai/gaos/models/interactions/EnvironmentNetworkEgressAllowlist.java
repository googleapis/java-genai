...
public class EnvironmentNetworkEgressAllowlist {
    ...
    public static EnvironmentNetworkEgressAllowlist of(Allowlist value) {
        ...
        return new EnvironmentNetworkEgressAllowlist(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>(){}));
    }
     ...
     * <ul>
     * <li>{@code com.google.genai.gaos.models.interactions.Allowlist}</li>
     * <li>{@code com.google.genai.gaos.models.interactions.Disabled}</li>
     * </ul>
     * 
