...
public class CreateTriggerRequest {
    ...
    @JsonIgnore
    public TriggerCreateParams body() {
        return body;
    }
     ...
     * Which version of the API to use.
     */
    public CreateTriggerRequest withApiVersion(String apiVersion) {
        Utils.checkNotNull(apiVersion, "apiVersion");
     ...
     * Which version of the API to use.
     */
    public CreateTriggerRequest withApiVersion(Optional<String> apiVersion) {
        Utils.checkNotNull(apiVersion, "apiVersion");
        this.apiVersion = apiVersion;
        return this;
    }

    public CreateTriggerRequest withBody(TriggerCreateParams body) {
        Utils.checkNotNull(body, "body");
        this.body = body;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder body(TriggerCreateParams body) {
            Utils.checkNotNull(body, "body");
            this.body = body;
            return this;
        }
