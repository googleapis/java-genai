...
public class InteractionsInput {
  ...
  public static InteractionsInput ofStep(List<Step> value) {
    Utils.checkNotNull(value, "value");
    return new InteractionsInput(
        TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<List<Step>>() {}));
  }

  public static InteractionsInput ofContent(List<Content> value) {
    Utils.checkNotNull(value, "value");
    return new InteractionsInput(
        TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<List<Content>>() {}));
  }

  public static InteractionsInput ofTurn(List<Turn> value) {
    Utils.checkNotNull(value, "value");
    return new InteractionsInput(
        TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<List<Turn>>() {}));
  }

  public static InteractionsInput of(Content value) {
    Utils.checkNotNull(value, "value");
    return new InteractionsInput(
        TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<Content>() {}));
  }
  ...
  /**
   * Returns an {@link Optional} containing the value if it is of type {@code List<Step>}, otherwise
   * returns an empty {@link Optional}.
   *
   * @return an {@link Optional} containing the {@code List<Step>} value, or empty if not of this
   *     type
   */
  @SuppressWarnings("unchecked")
  public Optional<List<Step>> arrayOfStep() {
    if (value.value() instanceof List) {
      return Optional.of((List<Step>) value.value());
    }
    return Optional.empty();
  }
   ...
   *
   * @return an {@link Optional} containing the {@code List<Content>} value, or empty if not of this
   *     type
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * Returns an {@link Optional} containing the value if it is of type {@code List<Turn>}, otherwise
   * returns an empty {@link Optional}.
   *
   * @return an {@link Optional} containing the {@code List<Turn>} value, or empty if not of this
   *     type
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * Returns an {@link Optional} containing the value if it is of type {@code Content}, otherwise
   * returns an empty {@link Optional}.
   *
