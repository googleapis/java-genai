...
public class InteractionsInput {
    ...
    public static InteractionsInput of(String value) {
        ...
        return new InteractionsInput(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>(){}));
    }
     ...
     * <li>{@code java.util.List<com.google.genai.gaos.models.interactions.Step>}</li>
     * <li>{@code java.util.List<com.google.genai.gaos.models.interactions.Content>}</li>
     * <li>{@code java.util.List<com.google.genai.gaos.models.interactions.Turn>}</li>
     * <li>{@code com.google.genai.gaos.models.interactions.Content}</li>
     * </ul>
     * 
