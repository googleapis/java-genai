...
public class InteractionCreatedEvent implements InteractionSSEEvent {
  ...
  /** The event_id token to be used to resume the interaction stream, from this event. */
  public InteractionCreatedEvent withEventId(@Nullable String eventId) {
    this.eventId = eventId;
    return this;
  }
   ...
   * payloads may omit fields that are only available on full non-streaming Interaction responses.
   */
  public InteractionCreatedEvent withInteraction(
  ...
  public static final class Builder {
    ...
    public InteractionCreatedEvent build() {
      return new InteractionCreatedEvent(eventId, metadata, interaction);
    }

    private static final LazySingletonValue<String> _SINGLETON_VALUE_EventType =
        new LazySingletonValue<>(
            "event_type", "\"interaction.created\"", new TypeReference<String>() {});
  }
}
