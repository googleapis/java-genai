...
public class InteractionCreatedEvent implements InteractionSSEEvent {
     ...
     * full non-streaming Interaction responses.
     */
    public InteractionCreatedEvent withInteraction(@Nonnull InteractionSseEventInteraction interaction) {
    ...
    public String toString() {
        return Utils.toString(
                InteractionCreatedEvent.class, "eventId", eventId, "eventType", eventType, "interaction", interaction);
    }
