...
public class GetInteractionByIdRequest {
  ...
  /**
   * Optional. If set, resumes the interaction stream from the next chunk after the event marked by
  ...
  public GetInteractionByIdRequest(
    ...
    this.includeInput =
        Optional.ofNullable(includeInput).orElse(Builder._SINGLETON_VALUE_IncludeInput.value());
  ...
  public static final class Builder {
    ...
    @Deprecated private Boolean includeInput;
