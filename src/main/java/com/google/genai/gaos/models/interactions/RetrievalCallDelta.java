 ...
 * RetrievalCallDelta
 *
 * <p>Used by Vertex Retrieval tools such as Parallel AI, Exa AI, Vertex AI Search, etc.
 * RetrievalType decides which tool is used.
 */
public class RetrievalCallDelta implements StepDeltaData {
  ...
  /** The type of retrieval tools. */
  public RetrievalCallDelta withRetrievalType(
      @Nullable RetrievalCallDeltaRetrievalType retrievalType) {
    this.retrievalType = retrievalType;
    return this;
  }
