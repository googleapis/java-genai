...
public class VerbatimTranscriptionMode implements TranscriptionMode {
     ...
     * Optional. Configures speaker diarization. Supported values: "speaker".
     */
    public VerbatimTranscriptionMode withDiarizationMode(@Nullable String diarizationMode) {
        this.diarizationMode = diarizationMode;
        return this;
    }
     ...
     * Supported values: "word". If empty, no timestamps are generated.
     */
    public VerbatimTranscriptionMode withTimestampGranularities(@Nullable List<String> timestampGranularities) {
        this.timestampGranularities = timestampGranularities;
        return this;
    }
