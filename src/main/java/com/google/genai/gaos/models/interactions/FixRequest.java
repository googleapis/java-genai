 ...
 * FixRequest
 *
 * <p>Request parameters specific to FIX sessions, used for generating and validating security
 * patches.
 */
public class FixRequest {
  ...
  public static final class Builder {
    ...
    /**
     * The identifier of the specific security finding to be remediated. This ID maps to a
     * previously discovered vulnerability.
     */
