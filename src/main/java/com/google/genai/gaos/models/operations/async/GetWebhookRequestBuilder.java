...
public class GetWebhookRequestBuilder {
    ...
    public GetWebhookRequestBuilder apiVersion(String apiVersion) {
        Utils.checkNotNull(apiVersion, "apiVersion");
        this.apiVersion = Optional.of(apiVersion);
        return this;
    }

    public GetWebhookRequestBuilder apiVersion(Optional<String> apiVersion) {
        Utils.checkNotNull(apiVersion, "apiVersion");
    ...
    private GetWebhookRequest buildRequest() {
        ...
        GetWebhookRequest request = new GetWebhookRequest(apiVersion,
            id);
