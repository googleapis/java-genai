...
public class WebhookUpdate {
  ...
  /**
   * Optional. The events that the webhook is subscribed to. Available events: - batch.succeeded -
  ...
  public WebhookUpdate(
      ...
      @JsonProperty("subscribed_events") @Nullable
          List<WebhookUpdateSubscribedEvent> subscribedEvents,
   ...
   * interaction.failed - video.generated
   */
  public WebhookUpdate withSubscribedEvents(
      @Nullable List<WebhookUpdateSubscribedEvent> subscribedEvents) {
    this.subscribedEvents = subscribedEvents;
    return this;
  }
