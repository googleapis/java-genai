...
public class Model {
  ...
  public static final Model GEMINI31_PRO_PREVIEW_CUSTOMTOOLS =
      new Model("gemini-3.1-pro-preview-customtools");
  ...
  public static final Model GEMINI_ROBOTICS_ER16_PREVIEW =
      new Model("gemini-robotics-er-1.6-preview");
  ...
  /**
   * Returns a Model with the given value. For a specific value the returned object will always be a
