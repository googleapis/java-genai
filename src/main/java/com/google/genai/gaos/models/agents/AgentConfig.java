...
public class AgentConfig {
  ...
  public static AgentConfig of(AntigravityAgentConfig value) {
    ...
    return new AgentConfig(
        TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<AntigravityAgentConfig>() {}));
  }

  /**
   * Returns an {@link Optional} containing the value if it is of type {@code
   * AntigravityAgentConfig}, otherwise returns an empty {@link Optional}.
   *
   * @return an {@link Optional} containing the {@code AntigravityAgentConfig} value, or empty if
   *     not of this type
   */
  public Optional<AntigravityAgentConfig> antigravityAgentConfig() {
    if (value.value() instanceof AntigravityAgentConfig) {
      return Optional.of((AntigravityAgentConfig) value.value());
    }
    ...
    public _Deserializer() {
      super(
          ...
          TypeReferenceWithShape.of(
              new TypeReference<AntigravityAgentConfig>() {}, JsonShape.DEFAULT));
    }
  }
