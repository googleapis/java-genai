 ...
 * Task
 *
 * <p>Optional task mode for video generation. If not specified, the model automatically determines
 * the appropriate mode based on the provided text prompt and input media.
 */
public class Task {
  ...
  /**
   * Returns a Task with the given value. For a specific value the returned object will always be a
