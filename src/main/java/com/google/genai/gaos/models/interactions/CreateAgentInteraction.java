...
public class CreateAgentInteraction {
  ...
  /**
   * The environment configuration for the interaction. Can be an object specifying remote
  ...
  public CreateAgentInteraction(
      ...
      @JsonProperty("response_format") @Nullable
          CreateAgentInteractionResponseFormat responseFormat,
  ...
  public CreateAgentInteraction(@Nonnull AgentOption agent, @Nonnull InteractionsInput input) {
    this(
        agent, null, null, null, null, null, null, null, null, null, null, null, null, null, null,
        null, input);
  }
  ...
  /** The requested modalities of the response (TEXT, IMAGE, AUDIO). */
  public CreateAgentInteraction withResponseModalities(
      @Nullable List<ResponseModality> responseModalities) {
    this.responseModalities = responseModalities;
    return this;
  }
   ...
   * specified in this field.
   */
  public CreateAgentInteraction withResponseFormat(
      @Nullable CreateAgentInteractionResponseFormat responseFormat) {
    this.responseFormat = responseFormat;
    return this;
  }
   ...
   * environment sources or a string referencing an existing environment ID.
   */
  public CreateAgentInteraction withEnvironment(
      @Nullable CreateAgentInteractionEnvironment environment) {
    this.environment = environment;
    return this;
  }

  /** Configuration parameters for the agent interaction. */
  public CreateAgentInteraction withAgentConfig(
      @Nullable CreateAgentInteractionAgentConfig agentConfig) {
    this.agentConfig = agentConfig;
    return this;
  }
  ...
  public static final class Builder {
    ...
    @Deprecated private String responseMimeType;
