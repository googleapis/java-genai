...
public class ListWebhooksRequestBuilder {
  ...
  private final ListWebhooksRequest.Builder pojoBuilder;
  ...
  public ListWebhooksRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    this.pojoBuilder = ListWebhooksRequest.builder();
    this.optionsBuilder = Options.builder();
  }

  public ListWebhooksRequestBuilder apiVersion(@Nullable String apiVersion) {
    this.pojoBuilder.apiVersion(apiVersion);
    this._setterCalled = true;
    return this;
  }

  public ListWebhooksRequestBuilder pageSize(@Nullable Integer pageSize) {
    this.pojoBuilder.pageSize(pageSize);
    this._setterCalled = true;
    return this;
  }

  public ListWebhooksRequestBuilder pageToken(@Nullable String pageToken) {
  ...
  private ListWebhooksRequest _buildRequest() {
  ...
  public ListWebhooksRequestBuilder header(String name, String value) {
   ...
   */
  public CompletableFuture<ListWebhooksResponse> call() {
