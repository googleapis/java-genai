 ...
 * Allowlist
 *
 * <p>Outbound networking configuration for the sandbox. When specified, restricts which external
 * domains the sandbox can reach. Omit entirely to allow all outbound traffic with no header
 * injection.
 */
public class Allowlist {
  /**
   * List of allowed outbound domains. Only requests to listed domains are permitted. Use
   * [{'domain': '*'}] to allow all domains while still injecting headers on specific ones.
   */
