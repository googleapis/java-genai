...
public class CodeMenderAgentConfig
  ...
  /**
   * Request parameters specific to FIND sessions, used for discovering vulnerabilities in a
   * codebase.
   */
  ...
  /**
   * Request parameters specific to FIX sessions, used for generating and validating security
   * patches.
   */
  @JsonInclude(Include.NON_ABSENT)
  ...
  public static final class Builder {
    ...
    /**
     * The name of the model to use for the CodeMender agent. One CodeMender session will only use
     * one model.
     */
