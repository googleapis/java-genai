...
public abstract class GenAiException extends RuntimeException {
  ...
  /**
   * Returns the raw HTTP response associated with this exception. The response body stream may not
   * be available (but the body can be accessed via the {@code body()} method).
   *
