...
public class CreateTriggerRequestBuilder {
  ...
  private final CreateTriggerRequest.Builder pojoBuilder;
  private CreateTriggerRequest request;
  private final Options.Builder optionsBuilder;
  private boolean _setterCalled;

  public CreateTriggerRequestBuilder(SDKConfiguration sdkConfiguration) {
    this.sdkConfiguration = sdkConfiguration;
    this.pojoBuilder = CreateTriggerRequest.builder();
    this.optionsBuilder = Options.builder();
  }

  public CreateTriggerRequestBuilder apiVersion(@Nullable String apiVersion) {
    this.pojoBuilder.apiVersion(apiVersion);
    this._setterCalled = true;
    return this;
  }

  public CreateTriggerRequestBuilder body(@Nonnull TriggerCreateParams body) {
    this.pojoBuilder.body(body);
    this._setterCalled = true;
    return this;
  }

  public CreateTriggerRequestBuilder retryConfig(RetryConfig retryConfig) {
    this.optionsBuilder.retryConfig(retryConfig);
    return this;
  }

  private CreateTriggerRequest _buildRequest() {
