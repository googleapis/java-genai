...
public class CreateTriggerRequestBuilder {
    ...
    public CreateTriggerRequestBuilder apiVersion(String apiVersion) {
        Utils.checkNotNull(apiVersion, "apiVersion");
        this.apiVersion = Optional.of(apiVersion);
        return this;
    }

    public CreateTriggerRequestBuilder apiVersion(Optional<String> apiVersion) {
        Utils.checkNotNull(apiVersion, "apiVersion");
        this.apiVersion = apiVersion;
        return this;
    }

    public CreateTriggerRequestBuilder body(TriggerCreateParams body) {
    ...
    public CreateTriggerRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
    ...
    private CreateTriggerRequest buildRequest() {

        CreateTriggerRequest request = new CreateTriggerRequest(apiVersion,
            body);
    ...
    public CompletableFuture<CreateTriggerResponse> call() {
        ...
        AsyncRequestOperation<CreateTriggerRequest, CreateTriggerResponse> operation
              = new CreateTrigger.Async(
                                    ...
                                    _headers);
        CreateTriggerRequest request = buildRequest();
