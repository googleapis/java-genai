...
public class ComputerUse implements Tool {
  ...
  @JsonCreator
  public ComputerUse(
      @JsonProperty("disabled_safety_policies") @Nullable
          List<DisabledSafetyPolicy> disabledSafetyPolicies,
      @JsonProperty("enable_prompt_injection_detection") @Nullable
          Boolean enablePromptInjectionDetection,
      @JsonProperty("environment") @Nullable EnvironmentEnum environment,
      @JsonProperty("excluded_predefined_functions") @Nullable
  ...
  /** Optional. Disabled safety policies for computer use. */
  public ComputerUse withDisabledSafetyPolicies(
      @Nullable List<DisabledSafetyPolicy> disabledSafetyPolicies) {
    this.disabledSafetyPolicies = disabledSafetyPolicies;
    return this;
  }

  /** Whether enable the prompt injection detection check on computer-use request. */
  public ComputerUse withEnablePromptInjectionDetection(
      @Nullable Boolean enablePromptInjectionDetection) {
    this.enablePromptInjectionDetection = enablePromptInjectionDetection;
    return this;
  }
  ...
  /** The list of predefined functions that are excluded from the model call. */
  public ComputerUse withExcludedPredefinedFunctions(
      @Nullable List<String> excludedPredefinedFunctions) {
    this.excludedPredefinedFunctions = excludedPredefinedFunctions;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Utils.enhancedDeepEquals(this.disabledSafetyPolicies, other.disabledSafetyPolicies)
        && Utils.enhancedDeepEquals(
            this.enablePromptInjectionDetection, other.enablePromptInjectionDetection)
        && Utils.enhancedDeepEquals(this.environment, other.environment)
        && Utils.enhancedDeepEquals(
            this.excludedPredefinedFunctions, other.excludedPredefinedFunctions)
  ...
  public static final class Builder {
    ...
    /** Optional. Disabled safety policies for computer use. */
    public Builder disabledSafetyPolicies(
        @Nullable List<DisabledSafetyPolicy> disabledSafetyPolicies) {
      this.disabledSafetyPolicies = disabledSafetyPolicies;
      return this;
    }
    ...
    /** Whether enable the prompt injection detection check on computer-use request. */
    public Builder enablePromptInjectionDetection(
        @Nullable Boolean enablePromptInjectionDetection) {
      this.enablePromptInjectionDetection = enablePromptInjectionDetection;
      return this;
    }
