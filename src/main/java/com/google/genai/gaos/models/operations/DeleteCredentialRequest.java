...
public class DeleteCredentialRequest {
     ...
     * Which version of the API to use.
     */
    public DeleteCredentialRequest withApiVersion(@Nullable String apiVersion) {
        this.apiVersion = apiVersion;
        return this;
    }
     ...
     * collection as described in https://google.aip.dev/122.
     */
    public DeleteCredentialRequest withId(@Nonnull String id) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteCredentialRequest other = (DeleteCredentialRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteCredentialRequest.class,
