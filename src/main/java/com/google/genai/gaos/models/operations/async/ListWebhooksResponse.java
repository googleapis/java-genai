...
public class ListWebhooksResponse implements AsyncResponse {
    ...
    public Optional<WebhookListResponse> webhookListResponse() {
        return Optional.ofNullable(this.webhookListResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public ListWebhooksResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListWebhooksResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Successful operation
     */
    public ListWebhooksResponse withWebhookListResponse(@Nullable WebhookListResponse webhookListResponse) {
        this.webhookListResponse = webhookListResponse;
        return this;
    }
    ...
    public static final class Builder {
         ...
         * Successful operation
         */
        public Builder webhookListResponse(@Nullable WebhookListResponse webhookListResponse) {
            this.webhookListResponse = webhookListResponse;
            return this;
        }
