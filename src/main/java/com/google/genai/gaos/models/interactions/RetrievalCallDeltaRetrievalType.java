...
public enum RetrievalCallDeltaRetrievalType {
    ...
    RetrievalCallDeltaRetrievalType(String value) {
        this.value = value;
    }
    ...
    public static Optional<RetrievalCallDeltaRetrievalType> fromValue(String value) {
        for (RetrievalCallDeltaRetrievalType o: RetrievalCallDeltaRetrievalType.values()) {
