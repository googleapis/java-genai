...
public class ModelOutputStep implements Step {
   ...
   * details.
   *
   * <p>You can find out more about this error model and how to work with it in the [API Design
  ...
  public static final class Builder {
     ...
     * [gRPC](https://github.com/grpc). Each `Status` message contains three pieces of data: error
