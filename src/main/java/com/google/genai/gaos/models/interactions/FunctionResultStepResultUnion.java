...
public class FunctionResultStepResultUnion {
   ...
   * FunctionResultStepResult}, otherwise returns an empty {@link Optional}.
   *
   * @return an {@link Optional} containing the {@code FunctionResultStepResult} value, or empty if
   *     not of this type
   */
    ...
    public _Deserializer() {
      super(
          ...
          TypeReferenceWithShape.of(
              new TypeReference<FunctionResultStepResult>() {}, JsonShape.DEFAULT),
          TypeReferenceWithShape.of(
