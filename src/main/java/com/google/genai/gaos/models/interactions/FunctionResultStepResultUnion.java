...
public class FunctionResultStepResultUnion {
    ...
    public static FunctionResultStepResultUnion of(FunctionResultStepResult value) {
        ...
        return new FunctionResultStepResultUnion(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>(){}));
    }
     ...
     * <ul>
     * <li>{@code com.google.genai.gaos.models.interactions.FunctionResultStepResult}</li>
