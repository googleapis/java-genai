...
/**
 * AnnotationTypeIdResolver
 *
 * <p>Citation information for model-generated content.
 */
public class AnnotationTypeIdResolver extends GenericTypeIdResolver<Annotation> {

  public AnnotationTypeIdResolver() {
    super(UnknownAnnotation.class);
    initializeTypeMap();
  }
  ...
  public String idFromValue(Object value) {
    ...
    if (value instanceof Annotation) {
      Annotation discriminated = (Annotation) value;
  ...
  public String getDescForKnownTypeIds() {
    return "Annotation type resolver";
  }
}
