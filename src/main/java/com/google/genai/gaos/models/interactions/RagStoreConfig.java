...
public class RagStoreConfig {
  ...
  public int hashCode() {
    return Utils.enhancedHash(
        ragResources, ragRetrievalConfig, similarityTopK, vectorDistanceThreshold);
  }
  ...
  public static final class Builder {
    ...
    @Deprecated private Integer similarityTopK;

    @Deprecated private Double vectorDistanceThreshold;
