...
public class Interaction {
  ...
  public Interaction(@Nonnull InteractionStatus status) {
    this(
        null, null, null, status, null, null, null, null, null, null, null, null, null, null, null,
  ...
  public void setOutputs(List<Content> outputs) {
    if (outputs != null && !outputs.isEmpty()) {
      ModelOutputStep modelOutputStep = ModelOutputStep.builder().content(outputs).build();
