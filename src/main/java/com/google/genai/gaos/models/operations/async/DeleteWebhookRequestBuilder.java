...
public class DeleteWebhookRequestBuilder {
  ...
  private final DeleteWebhookRequest.Builder pojoBuilder;
  private DeleteWebhookRequest request;
  private final Options.Builder optionsBuilder;
  private boolean _setterCalled;

  public DeleteWebhookRequestBuilder(SDKConfiguration sdkConfiguration) {
    this.sdkConfiguration = sdkConfiguration;
    this.pojoBuilder = DeleteWebhookRequest.builder();
    this.optionsBuilder = Options.builder();
  }

  public DeleteWebhookRequestBuilder apiVersion(@Nullable String apiVersion) {
    this.pojoBuilder.apiVersion(apiVersion);
    this._setterCalled = true;
    return this;
  }

  public DeleteWebhookRequestBuilder id(@Nonnull String id) {
  ...
  private DeleteWebhookRequest _buildRequest() {
