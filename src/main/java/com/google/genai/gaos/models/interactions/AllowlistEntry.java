...
public class AllowlistEntry {
    ...
    private Optional<? extends Transform> transform;

    @JsonCreator
    public AllowlistEntry(
            @JsonProperty("domain") String domain,
            @JsonProperty("transform") Optional<? extends Transform> transform) {
    ...
    public Optional<Transform> transform() {
        return (Optional<Transform>) transform;
    }
     ...
     * dicts. The egress proxy injects these automatically.
     */
    public AllowlistEntry withTransform(Transform transform) {
        Utils.checkNotNull(transform, "transform");
     ...
     * dicts. The egress proxy injects these automatically.
     */
    public AllowlistEntry withTransform(Optional<? extends Transform> transform) {
        Utils.checkNotNull(transform, "transform");
        this.transform = transform;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends Transform> transform = Optional.empty();
         ...
         * dicts. The egress proxy injects these automatically.
         */
        public Builder transform(Optional<? extends Transform> transform) {
            Utils.checkNotNull(transform, "transform");
            this.transform = transform;
            return this;
        }
