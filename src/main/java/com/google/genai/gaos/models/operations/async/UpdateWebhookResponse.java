...
public class UpdateWebhookResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public UpdateWebhookResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateWebhookResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Successful operation
     */
    public UpdateWebhookResponse withWebhook(@Nullable Webhook webhook) {
        this.webhook = webhook;
        return this;
    }
    ...
    public static final class Builder {
        ...
        public UpdateWebhookResponse build() {
            return new UpdateWebhookResponse(contentType, statusCode, rawResponse, webhook);
        }
    }
}
