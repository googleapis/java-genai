    ...
    */
    public static DeleteInteractionServerError from(HttpResponse<InputStream> response) {
        try {
            ...
            return new DeleteInteractionServerError(response.statusCode(), bytes, response, data, null);
        } catch (Exception e) {
            return new DeleteInteractionServerError(response.statusCode(), null, response, null, e);
        }
    }

    /**
    * Parse a response into an instance of DeleteInteractionServerError asynchronously. If deserialization of the response body fails,
    * the resulting DeleteInteractionServerError instance will have a null data() value and a non-null deserializationException().
    */
    public static CompletableFuture<DeleteInteractionServerError> fromAsync(HttpResponse<Blob> response) {
        return response.body()
                ...
                .handle((bytes, err) -> {
                    ...
                    try {
                        return new DeleteInteractionServerError(
                                response.statusCode(),
                                bytes,
                                response,
