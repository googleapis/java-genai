...
public class DeleteInteractionServerError extends GenAiException {
  ...
  /**
   * Parse a response into an instance of DeleteInteractionServerError. If deserialization of the
   * response body fails, the resulting DeleteInteractionServerError instance will have a null
