...
public class SpeechConfigUnion {
     ...
     *
     * @return an {@link Optional} containing the {@code SpeakerConfig} value, or empty if not of this type
     */
    public Optional<SpeakerConfig> speakerConfig() {
        if (value.value() instanceof SpeakerConfig) {
            return Optional.of((SpeakerConfig) value.value());
        }
     ...
     * otherwise returns an empty {@link Optional}.
     *
     * @return an {@link Optional} containing the {@code List<SpeechConfig>} value, or empty if not of this type
     */
    @SuppressWarnings("unchecked")
    public Optional<List<SpeechConfig>> arrayOfSpeechConfig() {
        if (value.value() instanceof List) {
            return Optional.of((List<SpeechConfig>) value.value());
        }
        return Optional.empty();
    }
   /**
