...
public class CreateInteractionResponse implements AsyncResponse {
     ...
     * HTTP response content type for this operation
     */
    public CreateInteractionResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateInteractionResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Successful operation
     */
    public CreateInteractionResponse withInteraction(@Nullable Interaction interaction) {
        this.interaction = interaction;
        return this;
    }
