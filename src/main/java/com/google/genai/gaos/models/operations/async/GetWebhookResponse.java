...
public class GetWebhookResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public GetWebhookResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetWebhookResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Successful operation
     */
    public GetWebhookResponse withWebhook(@Nullable Webhook webhook) {
        this.webhook = webhook;
        return this;
    }
