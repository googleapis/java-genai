...
public class CreateModelInteraction {
  ...
  public CreateModelInteraction(
      ...
      @JsonProperty("response_format") @Nullable
          CreateModelInteractionResponseFormat responseFormat,
  ...
  public CreateModelInteraction(@Nonnull Model model, @Nonnull InteractionsInput input) {
    this(
        model, null, null, null, null, null, null, null, null, null, null, null, null, null, null,
        null, input);
  }
  ...
  /** The requested modalities of the response (TEXT, IMAGE, AUDIO). */
  public CreateModelInteraction withResponseModalities(
   ...
   * specified in this field.
   */
  public CreateModelInteraction withResponseFormat(
      @Nullable CreateModelInteractionResponseFormat responseFormat) {
    this.responseFormat = responseFormat;
    return this;
  }
   ...
   * environment sources or a string referencing an existing environment ID.
   */
  public CreateModelInteraction withEnvironment(
      @Nullable CreateModelInteractionEnvironment environment) {
    this.environment = environment;
    return this;
  }
