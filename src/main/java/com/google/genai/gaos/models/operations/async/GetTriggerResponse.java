...
public class GetTriggerResponse implements AsyncResponse {
     ...
     * HTTP response status code for this operation
     */
    public GetTriggerResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetTriggerResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Successful operation
     */
    public GetTriggerResponse withTrigger(Optional<? extends Trigger> trigger) {
        Utils.checkNotNull(trigger, "trigger");
        this.trigger = trigger;
        return this;
    }
