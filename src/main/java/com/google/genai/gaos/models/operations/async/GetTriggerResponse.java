...
public class GetTriggerResponse implements AsyncResponse {
     ...
     * HTTP response content type for this operation
     */
    public GetTriggerResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetTriggerResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Successful operation
     */
    public GetTriggerResponse withTrigger(@Nullable Trigger trigger) {
        this.trigger = trigger;
        return this;
    }
