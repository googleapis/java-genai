...
public class CancelInteractionByIdRequest {
    ...
    @JsonCreator
    public CancelInteractionByIdRequest(@Nullable String apiVersion, @Nonnull String id) {
    ...
    public String toString() {
        return Utils.toString(CancelInteractionByIdRequest.class, "apiVersion", apiVersion, "id", id);
    }
    ...
    public static final class Builder {
        ...
        public CancelInteractionByIdRequest build() {
            return new CancelInteractionByIdRequest(apiVersion, id);
        }
    }
}
