...
public class URLContextCallDelta {
     ...
     * The arguments to pass to the URL context.
     */
    public URLContextCallDelta withArguments(URLContextCallArguments arguments) {
        Utils.checkNotNull(arguments, "arguments");
        this.arguments = arguments;
        return this;
    }
     ...
     * A signature hash for backend validation.
     */
    public URLContextCallDelta withSignature(String signature) {
        Utils.checkNotNull(signature, "signature");
     ...
     * A signature hash for backend validation.
     */
    public URLContextCallDelta withSignature(Optional<String> signature) {
        Utils.checkNotNull(signature, "signature");
        this.signature = signature;
        return this;
    }
