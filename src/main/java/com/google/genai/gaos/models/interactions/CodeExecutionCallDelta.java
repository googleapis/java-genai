...
public class CodeExecutionCallDelta {
     ...
     * The arguments to pass to the code execution.
     */
    public CodeExecutionCallDelta withArguments(CodeExecutionCallArguments arguments) {
        Utils.checkNotNull(arguments, "arguments");
        this.arguments = arguments;
        return this;
    }
     ...
     * A signature hash for backend validation.
     */
    public CodeExecutionCallDelta withSignature(String signature) {
        Utils.checkNotNull(signature, "signature");
     ...
     * A signature hash for backend validation.
     */
    public CodeExecutionCallDelta withSignature(Optional<String> signature) {
        Utils.checkNotNull(signature, "signature");
        this.signature = signature;
        return this;
    }
