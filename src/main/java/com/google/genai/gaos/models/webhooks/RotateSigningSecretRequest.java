...
public class RotateSigningSecretRequest {
  ...
  /** Optional. The revocation behavior for previous signing secrets. */
  public RotateSigningSecretRequest withRevocationBehavior(
      @Nullable RevocationBehavior revocationBehavior) {
    this.revocationBehavior = revocationBehavior;
    return this;
  }
  ...
  public String toString() {
    return Utils.toString(
        RotateSigningSecretRequest.class, "revocationBehavior", revocationBehavior);
  }
