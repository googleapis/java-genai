...
public class CreateModelInteractionResponseFormat {
    ...
    public static CreateModelInteractionResponseFormat of(List<ResponseFormat> value) {
        ...
        return new CreateModelInteractionResponseFormat(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>(){}));
    }
    ...
    public String toString() {
        return Utils.toString(CreateModelInteractionResponseFormat.class,
                "value", value);
    }
