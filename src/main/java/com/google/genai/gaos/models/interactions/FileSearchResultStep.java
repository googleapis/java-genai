...
public class FileSearchResultStep implements Step {
  ...
  /** Required. ID to match the ID from the function call block. */
  public FileSearchResultStep withCallId(@Nonnull String callId) {
    this.callId = Utils.checkNotNull(callId, "callId");
    return this;
  }

  /** A signature hash for backend validation. */
  public FileSearchResultStep withSignature(@Nullable String signature) {
    this.signature = signature;
    return this;
  }
  ...
  public String toString() {
    return Utils.toString(
        FileSearchResultStep.class, "callId", callId, "signature", signature, "type", type);
  }
