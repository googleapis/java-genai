...
import com.google.genai.gaos.utils.reactive.ReactiveUtils;
...
public final class Multipart {
    ...
    private static BodyPublisher concat(BodyPublisher... publishers) {
        return BodyPublishers.fromPublisher(ReactiveUtils.concat(java.util.Arrays.asList(publishers)));
    }

    private static BodyPublisher concat(List<BodyPublisher> publishers) {
        List<Flow.Publisher<ByteBuffer>> bufferPublishers = java.util.Collections.unmodifiableList(new java.util.ArrayList<>(publishers));
