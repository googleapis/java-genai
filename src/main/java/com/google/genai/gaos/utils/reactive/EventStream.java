 ...
 */
package com.google.genai.gaos.utils.reactive;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.google.genai.gaos.utils.AsyncResponse;
import com.google.genai.gaos.utils.Blob;
import com.google.genai.gaos.utils.EventStreamMessage;
import com.google.genai.gaos.utils.SpeakeasyLogger;
import com.google.genai.gaos.utils.StreamingParser;
...
public class EventStream<ResponseT extends AsyncResponse, ItemT> implements Publisher<ItemT> {
    ...
    private static class SSEProtocol<ItemT> implements Protocol<EventStreamMessage, ItemT> {
        ...
        public ItemT processItem(EventStreamMessage message, ObjectMapper objectMapper, TypeReference<ItemT> typeReference) {
            ...
            if (dataRequired && !message.data().isPresent()) {
                return null;
            }
