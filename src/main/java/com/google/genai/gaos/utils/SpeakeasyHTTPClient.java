...
public class SpeakeasyHTTPClient implements HTTPClient {
  ...
  private OkHttpClient asyncCallClient(HttpRequest request) {
    boolean streaming =
        request.headers().get("Accept").stream()
   ...
   *
   * <p><strong>WARNING:</strong> This setting may expose sensitive information in logs (such as
   * {@code Authorization} headers) and should only be enabled temporarily for local debugging
   * purposes.
   *
   * <p>By default, {@code Authorization} headers are redacted in the logs (printed with a value of
   * {@code [*******]}). Header suppression can be controlled with the {@link
   * #setRedactedHeaders(Collection)} method.
   *
  ...
  /**
   * When debug logging is enabled, this method controls the suppression of header values in the
   * logs.
   *
   * <p>By default, {@code Authorization} headers are redacted in the logs (printed with a value of
   * {@code [*******]}).
   *
   * @param headerNames the names (case-insensitive) of the headers whose values will be redacted in
   *     the logs
  ...
  /**
   * When debug logging is enabled, this method adds a single header to the list of headers whose
   * values will be redacted in the logs.
   *
   * <p>By default, {@code Authorization} headers are redacted in the logs (printed with a value of
   * {@code [*******]}).
   *
   * @param headerName the name (case-insensitive) of the header whose value will be redacted in the
   *     logs
   * @see #setDebugLogging(boolean)
   * @see #setRedactedHeaders(Collection)
   */
