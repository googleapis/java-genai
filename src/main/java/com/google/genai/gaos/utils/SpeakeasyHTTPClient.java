...
public class SpeakeasyHTTPClient implements HTTPClient {
    ...
    // uppercase
    private static Set<String> redactedHeaders = java.util.Collections.unmodifiableSet(new java.util.HashSet<>(java.util.Arrays.asList("AUTHORIZATION", "X-API-KEY")));
    ...
    public static void addRedactedHeader(String headerName) {
        ...
        redactedHeaders = java.util.Collections.unmodifiableSet(updated);
    }
