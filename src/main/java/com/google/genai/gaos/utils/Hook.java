...
public final class Hook {
  ...
  public interface AfterSuccess {
     ...
     * @throws Exception on error
     */
    HttpResponse<InputStream> afterSuccess(
  ...
  public interface AfterError {
    ...
    /**
     * Either returns an HttpResponse or throws an Exception. Must be passed either a response or an
     * error (both can't be absent).
     *
     * @param context context for the error
     * @param response response information if available.
     * @param error the optional exception. If response present then the error is for-info only, it
     *     was the last error in the chain of AfterError hook calls leading to this one
