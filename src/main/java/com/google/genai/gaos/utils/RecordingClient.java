...
public final class RecordingClient implements HTTPClient {
    ...
    public HttpResponse<InputStream> send(HttpRequest request)
        ...
        for (java.util.function.UnaryOperator<HttpRequest> hook : beforeRequestHooks) {
            request = hook.apply(request);
        }
        requests.add(request);
        HttpResponse<InputStream> response = client.send(request);
        for (java.util.function.UnaryOperator<HttpResponse<InputStream>> hook : afterResponseHooks) {
