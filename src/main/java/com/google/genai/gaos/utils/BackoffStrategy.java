 ...
 *
 * <p>The duration between consecutive attempts is calculated as follows: intervalMs =
 * min(maxIntervalMs, initialIntervalMs*(baseFactor^attempts) +/- r) where baseFactor is the base
 * factor and r a random value between 0 and jitterFactor*intervalMs.
 */
