...
public class AsyncAgents {
   ...
   * Creates a new Agent (Typed version for SDK).
   *
   * @param body An agent definition for the CreateAgent API. This message is the target for
   *     annotation-parser-based JSON parsing. New format: { "id": "customer-sentinel",
   *     "base_agent": "", "system_instruction": "...", "base_environment": { "type": "remote",
   *     "sources": [...] }, "tools": [ {"type": "code_execution"} ] }
