...
public class AsyncWebhooks {
     ...
     */
    public CompletableFuture<CreateWebhookResponse> create(WebhookInput body) {
     ...
     */
    public CompletableFuture<RotateSigningSecretResponse> rotateSigningSecret(String id) {
     ...
     */
    public CompletableFuture<PingWebhookResponse> ping(String id) {
        return ping(
                Optional.empty(), id, Optional.empty(),
                Optional.empty());
    }
