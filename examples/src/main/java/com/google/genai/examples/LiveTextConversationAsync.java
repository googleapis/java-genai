...
public class LiveTextConversationAsync {
  ...
  public static void main(String[] args) throws IOException, HttpException {
    ...
    try {
      ...
      CompletableFuture<Void> receiveFuture = receive(session, allDone);
  ...
  private static CompletableFuture<Void> receive(
      AsyncSession session, CompletableFuture<Void> allDone) {
