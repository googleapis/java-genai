...
public final class Constants {
  ...
  /** The name of the Imagen model to be used in the examples. */
  public static final String IMAGEN_COMPATIBILITY_MODEL_NAME = "imagen-3.0-capability-001";

  /** The name of the Imagen recontext model to be used in the examples. */
  public static final String IMAGEN_RECONTEXT_MODEL_NAME = "imagen-product-recontext-preview-06-30";

  /** The name of the Imagen virtual try-on model to be used in the examples. */
  public static final String IMAGEN_VIRTUAL_TRY_ON_MODEL_NAME = "virtual-try-on-preview-08-04";

  /** The name of the Imagen segment model to be used in the examples. */
  public static final String IMAGEN_SEGMENT_MODEL_NAME = "image-segmentation-001";
