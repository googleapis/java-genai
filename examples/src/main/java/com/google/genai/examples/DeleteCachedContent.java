 ...
 *
 * <p>mvn clean compile exec:java -Dexec.mainClass="com.google.genai.examples.DeleteCachedContent"
 */
...
public class DeleteCachedContent {
  ...
  public static void main(String[] args) {
    ...
    DeleteCachedContentResponse response =
        client.caches.delete("cachedContents/1ir2m9fr5xif", null); // Replace with your cached content name.
